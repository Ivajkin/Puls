  ...
  <div id="page">
    ...
    <header id="header" role="banner" class="clearfix">
        <div class="section-1 clearfix">
        	...
        	<div class="col1">
            	<?php if ($logo): ?>
                    <a href="<?php print $front_page; ?>" title="<?php print 123; ?>" rel="home" id="logo">
                        <img src="<?php print $logo; ?>" alt="<?php print t('123'); ?>" />
                    </a>
                <?php endif; ?>
                ...
                <?php if ($site_name || $site_slogan): ?>
                    <div id="name-and-slogan">
                      <?php if ($site_name): ?>
                        <?php if ($title): ?>
                          <div id="site-name">
                            <strong><a href="<?php print $front_page; ?>" title="<?php print t('Главная'); ?>" rel="home"><span><?php print $site_name; ?></span></a></strong>
                          </div><!-- /#site-name -->
