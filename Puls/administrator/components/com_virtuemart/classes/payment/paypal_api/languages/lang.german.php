...
//PayPal NVP Errors
	...
	$nvp_error_10411 = 'Die PayPal Session ist abgelaufen. Bitte starten Sie den Kauf erneut.';
	$nvp_error_10415 = 'Diese PayPal Session wurde bereits f&uuml;r einen Kauf genutzt. Bitte starten Sie den Kauf erneut.';
	$nvp_error_10416 = 'Die maximale Anzahl der Zahlversuche f&uuml;r diese Session wurde &uuml;berschritten. Bitte starten Sie den Kauf erneut.';
	$nvp_error_10417 = 'Zahlung fehlgeschlagen. Bitte w&auml;hlen Sie eine andere Zahlmethode.';
	$nvp_error_10422 = 'Zahlung fehlgeschlagen. Bitte w&auml;hlen Sie eine andere Zahlmethode.';
	$nvp_error_10445 = 'Die Transaktion konnte nicht abgeschlossen werden. Bitte versuchen Sie es sp&auml;ter noch einmal.';
