if (typeof(MooTools) != 'undefined'){
		...
		Element.extend(
		{
			...
			init: function() {
				...
				if (this.parent._id)
				{
					this.myFx2 = new Fx.Style(this, 'width', {duration: 600});
					this.myFx2.set(0);
				}else{
					this.myFx2 = new Fx.Style(this, 'height', {duration: 600});
					this.myFx2.set(0);
				}
		...
		Window.onDomReady(function() {new DropdownMenu($E('#wdb_toolbar ul.menu'))});
