...
--
-- Хост: localhost
-- Время создания: Сен 04 2012 г., 11:02
...
--
-- Создание: Июн 03 2012 г., 17:01
-- Последнее обновление: Сен 04 2012 г., 08:42
--
...
--
-- Создание: Июн 03 2012 г., 17:01
-- Последнее обновление: Сен 03 2012 г., 18:09
--
...
(6, 'tataetd', 'tataetd', '', '<p>tadst</p>', '', 0, 0, 0, 0, '2012-06-06 14:56:38', 62, '', '2012-06-06 15:02:01', 62, 62, '2012-09-03 15:53:10', '2012-06-06 14:56:38', '0000-00-00 00:00:00', '', '', 'show_title=\nlink_titles=\nshow_intro=\nshow_section=\nlink_section=\nshow_category=\nlink_category=\nshow_vote=\nshow_author=\nshow_create_date=\nshow_modify_date=\nshow_pdf_icon=\nshow_print_icon=\nshow_email_icon=\nlanguage=\nkeyref=\nreadmore=', 3, 0, 2, '', '', 0, 0, 'robots=\nauthor='),
(7, '13', '123', '', '<p>&lt;?php if( !defined( ''_VALID_MOS'' ) &amp;&amp; !defined( ''_JEXEC'' ) ) die( ''Direct Access to ''.basename(__FILE__).'' is not allowed.'' );</p>\r\n<p>mm_showMyFileName(__FILE__);</p>\r\n<p>//Загрузка картинки</p>\r\n<p>?&gt;</p>\r\n<p> </p>\r\n<p>&lt;table border="0" cellspacing="0" cellpadding="0"&gt;</p>\r\n<p>&lt;tr&gt;</p>\r\n<p>&lt;td&gt;</p>\r\n<p>&lt;p width="33%" rowspan="&lt;?php echo $rowspan; ?&gt;" valign="top"&gt;&lt;br/&gt;</p>\r\n<p><span style="white-space: pre;"> </span>&lt;?php echo urldecode( $product_image ) ?&gt;&lt;?php echo $this-&gt;vmlistAdditionalImages( $product_id, $images ) ?&gt;&lt;/p&gt;</p>\r\n<p>&lt;/td&gt;</p>\r\n<p>&lt;td width="50"&gt;&amp;nbsp;&lt;/td&gt;</p>\r\n<p>&lt;td&gt;&lt;?php echo $addtocart; ?&gt;&lt;/td&gt;</p>\r\n<p>&lt;/tr&gt;</p>\r\n<p>&lt;/table&gt;</p>\r\n<p> </p>\r\n<p>&lt;?php</p>\r\n<p>jimport(''joomla.html.pane'');</p>\r\n<p>$myTabs = &amp; JPane::getInstance(''tabs'', array(''startOffset''=&gt;0));</p>\r\n<p>$output = '''';</p>\r\n<p>$output .= $myTabs-&gt;startPane( ''pane'' );</p>\r\n<p> </p>\r\n<p>//1 вкладка</p>\r\n<p>$output .= $myTabs-&gt;startPanel( ''&lt;span&gt;Описание&lt;/span&gt;'', ''tab1'' ); // добавляем вкладку с заголовком «Описание»</p>\r\n<p>$output .= ''&lt;div &gt;''.$product_description.''&lt;/div&gt;''; // выводим в контейнер под вкладкой описание товара из переменной $product_description</p>\r\n<p>$output .= $myTabs-&gt;endPanel();</p>\r\n<p> </p>\r\n<p>//2 вкладка</p>\r\n<p>$output .= $myTabs-&gt;startPanel( ''&lt;span&gt;Отзывы&lt;/span&gt;'', ''tab2'' ); // добавляем вкладку с заголовком «отзывы»</p>\r\n<p>$output .= ''&lt;div &gt;''.$product_reviews.''&lt;br&gt;''.$product_reviewform.''&lt;/div&gt;''; // выводим в контейнер под вкладкой отзывы о товаре из переменной $product_reviews и форму добавления отзывов из переменной $product_reviewform</p>\r\n<p>echo $output;</p>\r\n<p>\r\n', '\r\n</p>\r\n<p>$output .= $myTabs-&gt;endPanel();</p>\r\n<p> </p>\r\n<p>//3 вкладка</p>\r\n<p>$utput .= $myTabs-&gt;startPanel( ''&lt;span&gt;Дополнительные изображения&lt;/span&gt;'', ''tab3'' ); // добавляем вкладку с заголовком «Дополнительные изображения»</p>\r\n<p> </p>\r\n<p>$utput .= $myTabs-&gt;endPane();</p>\r\n<p>echo $utput;</p>\r\n<p>?&gt;</p>\r\n<p> </p>', -2, 0, 0, 0, '2012-06-17 06:27:42', 62, '', '2012-06-17 06:28:34', 62, 0, '0000-00-00 00:00:00', '2012-06-17 06:27:42', '0000-00-00 00:00:00', '', '', 'show_title=\nlink_titles=\nshow_intro=\nshow_section=\nlink_section=\nshow_category=\nlink_category=\nshow_vote=\nshow_author=\nshow_create_date=\nshow_modify_date=\nshow_pdf_icon=\nshow_print_icon=\nshow_email_icon=\nlanguage=\nkeyref=\nreadmore=', 2, 0, 0, '', '', 0, 2, 'robots=\nauthor=');
...
--
-- Создание: Июн 03 2012 г., 17:01
-- Последнее обновление: Июн 17 2012 г., 06:28
--
...
--
-- Создание: Июн 03 2012 г., 17:01
-- Последнее обновление: Сен 02 2012 г., 20:30
--
...
--
-- Создание: Июн 03 2012 г., 17:01
-- Последнее обновление: Сен 02 2012 г., 20:31
--
...
-- Последнее обновление: Июн 21 2012 г., 11:47
--
...
(7, 0, 0, '0', 0, 6, 'com_virtuemart', '', 'en-GB', 62, 'Administrator', 'admin', 'serega.khv@gmail.com', '', '', 'Тестовое стосимвольное сообщение. Тестовое стосимвольное сообщение. Тестовое стосимвольное сообщение. Тестовое стосимвольное сообщение.', '', '2012-06-04 08:04:00', 0, 0, 1, 0, 0, 'virtuemart', 0, 0, '0000-00-00 00:00:00', ''),
(5, 0, 0, '0', 0, 18, 'com_virtuemart', '', 'en-GB', 62, 'Administrator', 'admin', 'serega.khv@gmail.com', '', '', 'ntjfj', '92.37.190.128', '2012-06-04 16:37:53', 0, 0, 1, 0, 0, '', 0, 0, '0000-00-00 00:00:00', ''),
(6, 0, 0, '0', 0, 19, 'com_virtuemart', '', 'en-GB', 62, 'Administrator', 'admin', 'serega.khv@gmail.com', '', '', 'That so wonderful! That so wonderful! That so wonderful! That so wonderful! That so wonderful! That so wonderful!', '', '2012-06-04 07:01:00', 0, 0, 1, 0, 0, 'virtuemart', 0, 0, '0000-00-00 00:00:00', ''),
...
(8, 0, 0, '0', 0, 18, 'com_virtuemart', '', 'en-GB', 62, 'Administrator', 'admin', 'serega.khv@gmail.com', '', '', '122222222222222222222222222222222222222221212121212121212121212121212121212121212121212121212121221212', '', '2012-06-04 08:30:00', 2, 0, 1, 0, 0, 'virtuemart', 0, 0, '0000-00-00 00:00:00', ''),
(10, 0, 0, '0', 0, 22, 'com_virtuemart', '', 'ru-RU', 62, 'Administrator', 'admin', 'serega.khv@gmail.com', '', '', 'My comments', '92.37.191.100', '2012-06-06 09:54:49', 0, 0, 1, 0, 0, '', 0, 0, '0000-00-00 00:00:00', ''),
(11, 0, 0, '0', 0, 22, 'com_virtuemart', '', 'ru-RU', 62, 'Administrator', 'admin', 'serega.khv@gmail.com', '', '', '[quote name="Administrator"]My comments[/quote]<br />Mister Salyery sends regargs.', '92.37.191.100', '2012-06-06 09:55:49', 0, 0, 1, 0, 0, '', 0, 0, '0000-00-00 00:00:00', ''),
...
(16, 0, 0, '0', 0, 21, 'com_virtuemart', '', 'ru-RU', 62, 'Administrator', 'admin', 'serega.khv@gmail.com', '', '', '123 :D', '95.70.124.185', '2012-06-21 11:47:52', 0, 0, 1, 0, 0, '', 0, 0, '0000-00-00 00:00:00', '');
...
(7, 21, 'com_virtuemart', 'ru-RU', 'SCHILLER CARDIOVIT AT-1 с сумкой для переноски', 'http://coreatrade.com/paradigm/Puls/index.php?option=com_virtuemart&amp;page=shop.product_details&amp;flypage=flypage.tpl&amp;category_id=8&amp;product_id=21', 0, 0, 0, '2012-06-21 11:47:52'),
...
(13, 7, 'com_content', 'ru-RU', '13', '/paradigm/Puls/?option=com_content&amp;view=article&amp;id=7%3A123&amp;Itemid=1', 0, 62, 0, '2012-06-17 06:28:53'),
(14, 23, 'com_virtuemart', 'ru-RU', 'второй ряд', 'http://coreatrade.com/paradigm/Puls/index.php?option=com_virtuemart&amp;page=shop.product_details&amp;flypage=flypage.tpl&amp;category_id=8&amp;product_id=23', 0, 0, 0, '2012-06-19 04:44:14');
...
--
-- Создание: Июн 03 2012 г., 17:01
-- Последнее обновление: Сен 04 2012 г., 08:23
--
...
--
-- Создание: Июн 03 2012 г., 17:01
-- Последнее обновление: Июн 25 2012 г., 08:58
--
...
(16, 'VirtueMart Product Categories', '', 2, 'left', 62, '2012-06-25 08:58:06', 1, 'mod_product_categories', 0, 0, 0, 'menutype=dtree\njscook_type=tree\njscookMenu_style=ThemeOffice\nmenu_orientation=hbr\njscookTree_style=ThemeXP\nroot_label=Категории\ncache=0\nmoduleclass_sfx=\nclass_sfx=\n\n', 0, 0, ''),
...
--
-- Создание: Июн 03 2012 г., 17:01
-- Последнее обновление: Июн 17 2012 г., 06:11
--
...
(44, 'System - Virtuemart Multiupload', 'virtuemart_multiupload', 'system', 0, 0, 1, 0, 0, 62, '2012-06-17 06:11:38', '');
...
--
-- Создание: Июн 03 2012 г., 17:01
-- Последнее обновление: Сен 04 2012 г., 15:55
--
...
('', '1346773283', '9fb042e124d789d1ffe045af8b7a9ea1', 1, 0, '', 0, 0, '__default|a:9:{s:15:"session.counter";i:1;s:19:"session.timer.start";i:1346773283;s:18:"session.timer.last";i:1346773283;s:17:"session.timer.now";i:1346773283;s:22:"session.client.browser";s:74:"Mozilla/5.0 (Windows NT 6.1; WOW64; rv:5.0.1) Gecko/20100101 Firefox/5.0.1";s:8:"registry";O:9:"JRegistry":3:{s:17:"_defaultNameSpace";s:7:"session";s:9:"_registry";a:1:{s:7:"session";a:1:{s:4:"data";O:8:"stdClass":0:{}}}s:7:"_errors";a:0:{}}s:4:"user";O:5:"JUser":19:{s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:8:"usertype";s:15:"Public Frontend";s:5:"block";N;s:9:"sendEmail";i:0;s:3:"gid";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:3:"aid";i:0;s:5:"guest";i:1;s:7:"_params";O:10:"JParameter":7:{s:4:"_raw";s:0:"";s:4:"_xml";N;s:9:"_elements";a:0:{}s:12:"_elementPath";a:1:{i:0;s:81:"/home2/core5429/public_html/paradigm/Puls/libraries/joomla/html/parameter/element";}s:17:"_defaultNameSpace";s:8:"_default";s:9:"_registry";a:1:{s:8:"_default";a:1:{s:4:"data";O:8:"stdClass":0:{}}}s:7:"_errors";a:0:{}}s:9:"_errorMsg";N;s:7:"_errors";a:0:{}}s:16:"com_mailto.links";a:2:{s:40:"4451f27831d46ede2686d9e6be2fa8e8d0e254f8";O:8:"stdClass":2:{s:4:"link";s:80:"http://coreatrade.com/paradigm/Puls/index.php/component/content/article/4-news-3";s:6:"expiry";i:1346773283;}s:40:"540a154c9449e040d750669b83f81f1790b90fc7";O:8:"stdClass":2:{s:4:"link";s:93:"http://coreatrade.com/paradigm/Puls/index.php/component/content/article/2-2012-06-04-08-02-44";s:6:"expiry";i:1346773283;}}s:13:"session.token";s:32:"187912cac2edb7f2a48516330a2c0a8c";}auth|a:11:{s:11:"show_prices";i:1;s:7:"user_id";i:0;s:8:"username";s:4:"demo";s:5:"perms";s:0:"";s:10:"first_name";s:5:"guest";s:9:"last_name";s:0:"";s:16:"shopper_group_id";s:1:"5";s:22:"shopper_group_discount";s:4:"0.00";s:24:"show_price_including_tax";s:1:"1";s:21:"default_shopper_group";i:1;s:22:"is_registered_customer";b:0;}cart|a:1:{s:3:"idx";i:0;}recent|a:1:{s:3:"idx";i:0;}ps_vendor_id|i:1;minimum_pov|s:4:"0.00";vendor_currency|s:3:"RUB";vmUseGreyBox|s:1:"0";vmCartDirection|s:1:"0";'),
('', '1346774101', '77fd9b48d90eedabf48418c164846230', 1, 0, '', 0, 0, '__default|a:6:{s:22:"session.client.browser";s:106:"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.1 (KHTML, like Gecko) Chrome/21.0.1180.83 Safari/537.1";s:15:"session.counter";i:1;s:8:"registry";O:9:"JRegistry":3:{s:17:"_defaultNameSpace";s:7:"session";s:9:"_registry";a:1:{s:7:"session";a:1:{s:4:"data";O:8:"stdClass":0:{}}}s:7:"_errors";a:0:{}}s:4:"user";O:5:"JUser":19:{s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:8:"usertype";s:15:"Public Frontend";s:5:"block";N;s:9:"sendEmail";i:0;s:3:"gid";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:3:"aid";i:0;s:5:"guest";i:1;s:7:"_params";O:10:"JParameter":7:{s:4:"_raw";s:0:"";s:4:"_xml";N;s:9:"_elements";a:0:{}s:12:"_elementPath";a:1:{i:0;s:81:"/home2/core5429/public_html/paradigm/Puls/libraries/joomla/html/parameter/element";}s:17:"_defaultNameSpace";s:8:"_default";s:9:"_registry";a:1:{s:8:"_default";a:1:{s:4:"data";O:8:"stdClass":0:{}}}s:7:"_errors";a:0:{}}s:9:"_errorMsg";N;s:7:"_errors";a:0:{}}s:16:"com_mailto.links";a:2:{s:40:"4451f27831d46ede2686d9e6be2fa8e8d0e254f8";O:8:"stdClass":2:{s:4:"link";s:80:"http://coreatrade.com/paradigm/Puls/index.php/component/content/article/4-news-3";s:6:"expiry";i:1346774101;}s:40:"540a154c9449e040d750669b83f81f1790b90fc7";O:8:"stdClass":2:{s:4:"link";s:93:"http://coreatrade.com/paradigm/Puls/index.php/component/content/article/2-2012-06-04-08-02-44";s:6:"expiry";i:1346774101;}}s:13:"session.token";s:32:"a25ff92fed260243f8047b4955712589";}auth|a:11:{s:11:"show_prices";i:1;s:7:"user_id";i:0;s:8:"username";s:4:"demo";s:5:"perms";s:0:"";s:10:"first_name";s:5:"guest";s:9:"last_name";s:0:"";s:16:"shopper_group_id";s:1:"5";s:22:"shopper_group_discount";s:4:"0.00";s:24:"show_price_including_tax";s:1:"1";s:21:"default_shopper_group";i:1;s:22:"is_registered_customer";b:0;}cart|a:1:{s:3:"idx";i:0;}recent|a:1:{s:3:"idx";i:0;}ps_vendor_id|i:1;minimum_pov|s:4:"0.00";vendor_currency|s:3:"RUB";vmUseGreyBox|s:1:"0";vmCartDirection|s:1:"0";');
...
--
-- Создание: Июн 03 2012 г., 17:01
-- Последнее обновление: Сен 02 2012 г., 06:37
--
...
--
-- Создание: Июн 03 2012 г., 17:01
-- Последнее обновление: Сен 04 2012 г., 11:31
--
...
(62, 'Administrator', 'admin', 'serega.khv@gmail.com', '489adc58c6a87cd9bab807c6db96912a:HouBr41aNXZWtbGFif9Ypf513POn6tgS', 'Super Administrator', 0, 1, 25, '2012-05-04 03:52:29', '2012-09-04 11:31:20', '', 'admin_language=\nlanguage=\neditor=\nhelpsite=\ntimezone=0\n\n'),
(63, '1 2', 'a123', 'nowert@mail.ru', 'dab012871b64ab927ea5bb81d0d41f96:pKH2txmtkhF8o2HkoFMs8IXCadIJbMC9', 'Registered', 0, 0, 18, '2012-09-02 20:30:46', '0000-00-00 00:00:00', '', '\n');
...
--
-- Создание: Июн 03 2012 г., 17:01
-- Последнее обновление: Сен 01 2012 г., 06:07
--
...
(6, 1, 'Аудиометры', '', 'resized/_________________5041a61a1b24d_90x90.jpg', '_________________5041a61a3c0ec.jpg', 'Y', 1338736636, 1346479641, 'browse_3', 2, 'flypage.tpl', 2),
...
--
-- Создание: Июн 03 2012 г., 17:01
-- Последнее обновление: Июн 19 2012 г., 04:43
--
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='All products are stored here.' AUTO_INCREMENT=24 ;
...
(22, 1, 0, '12', 'Cовременный прибор для регистрации', '<p class="MsoNormal" style="mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; text-align: center; line-height: normal;" align="center"><span style="font-size: 10.5pt; font-family: ">Электрокардиограф CARDIOVIT AT-1 современный прибор для регистрации биоэлектрических потенциалов сердца при диагностике состояния сердечно-сосудистой системы человека.</span></p>\r\n<p class="MsoNormal" style="mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; line-height: normal;"><strong><span style="font-size: 10.5pt; font-family: ">Характеристики для транспортировки</span></strong><span style="font-size: 10.5pt; font-family: "> </span></p>\r\n<table class="MsoNormalTable" style="width: 375.0pt; mso-cellspacing: 1.5pt; mso-yfti-tbllook: 1184;" border="0" cellpadding="0" width="500">\r\n<tbody>\r\n<tr>\r\n<td style="width: 148.65pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="198">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">Габариты в   упаковке</span></strong><span style="font-size: 12.0pt; font-family: "> </span></p>\r\n</td>\r\n<td style="width: 221.85pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="296">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">0,28х0,37х0,38</span></strong></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.65pt; padding: .75pt .75pt .75pt .75pt;" width="198">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">Вес, кг</span></strong></p>\r\n</td>\r\n<td style="width: 221.85pt; padding: .75pt .75pt .75pt .75pt;" width="296">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">5</span></strong></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.65pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="198">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">Объем,   м.куб.</span></strong></p>\r\n</td>\r\n<td style="width: 221.85pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="296">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">0.0394</span></strong></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.65pt; padding: .75pt .75pt .75pt .75pt;" width="198">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">Страна</span></strong></p>\r\n</td>\r\n<td style="width: 221.85pt; padding: .75pt .75pt .75pt .75pt;" width="296">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">Швейцария</span></strong></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.65pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="198">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">Производитель</span></strong></p>\r\n</td>\r\n<td style="width: 221.85pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="296">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: "><a href="http://www.medcomp.ru/manufacturer/168/"><span style="color: blue;">SCHILLER   AG</span></a></span></strong></p>\r\n</td>\r\n</tr>\r\n</tbody>\r\n</table>\r\n<p class="MsoNormal" style="mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; line-height: normal;"><span style="font-size: 10.5pt; font-family: ">Возможно хранение в памяти данных ЭКГ (12 сек.), с последующей печатью на термореактивной бумаге шириной 90 мм. В автоматическом режиме одновременно регистрируются 12 стандартных кардиографических отведений через 3 канала оптимизированных для ширины 80 мм. Изолинии настраиваются автоматически.Питание прибора осуществляется от сети переменного тока или от встроенной аккумуляторной батареи. Встроенная батарея аккумуляторов обеспечивает 2 часа работы с функцией печати. Время зарядки батарей - 15 часов при полностью разряженном аккумуляторе (3 часа до 60% заряда). Кабель отведений обеспечивает защиту от импульса дефибриллятора. Звуковая сигнализация сердечного ритма и аварийных ситуаций, наличие индикаторов контроля состояния аккумуляторной батареи и перегрузки усилителя биопотенциалов создают дополнительные удобства при работе с прибором. Наличие индикации показывает: питание от сети или батарей; низкий заряд батарей; отсутствие бумаги или неправильная заправка; состояние фильтра (вкл/выкл); нарушение контакта с электродом. Наличие миографического программируемого и линейного цифрового частотного фильтра обеспечивает высокое качество регистрации электрокардиограмм.</span></p>\r\n<p class="MsoNormal" style="mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; line-height: normal;"><strong><span style="font-size: 10.5pt; font-family: ">В комплект поставки входят:</span></strong></p>\r\n<ul type="disc">\r\n<li class="MsoNormal" style="color: black; mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; line-height: normal; mso-list: l0 level1 lfo1; tab-stops: list 36.0pt;"><span style="font-size: 10.5pt; font-family: ">12-проводной кабель пациента;</span></li>\r\n<li class="MsoNormal" style="color: black; mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; line-height: normal; mso-list: l0 level1 lfo1; tab-stops: list 36.0pt;"><span style="font-size: 10.5pt; font-family: ">4 электрода для конечностей,</span></li>\r\n<li class="MsoNormal" style="color: black; mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; line-height: normal; mso-list: l0 level1 lfo1; tab-stops: list 36.0pt;"><span style="font-size: 10.5pt; font-family: ">6 грудных грушевидных      электродов,</span></li>\r\n<li class="MsoNormal" style="color: black; mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; line-height: normal; mso-list: l0 level1 lfo1; tab-stops: list 36.0pt;"><span style="font-size: 10.5pt; font-family: ">электродный гель;</span></li>\r\n<li class="MsoNormal" style="color: black; mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; line-height: normal; mso-list: l0 level1 lfo1; tab-stops: list 36.0pt;"><span style="font-size: 10.5pt; font-family: ">сетевой кабель;</span></li>\r\n<li class="MsoNormal" style="color: black; mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; line-height: normal; mso-list: l0 level1 lfo1; tab-stops: list 36.0pt;"><span style="font-size: 10.5pt; font-family: ">упаковка регистрирующей бумаги;</span></li>\r\n<li class="MsoNormal" style="color: black; mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; line-height: normal; mso-list: l0 level1 lfo1; tab-stops: list 36.0pt;"><span style="font-size: 10.5pt; font-family: ">сумка для транспортировки.</span></li>\r\n</ul>\r\n<p class="MsoNormal" style="mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; line-height: normal;"><strong><span style="font-size: 10.5pt; font-family: ">Технические характеристики</span></strong></p>\r\n<table class="MsoNormalTable" style="width: 375.0pt; mso-cellspacing: 1.5pt; mso-yfti-tbllook: 1184;" border="0" cellpadding="0" width="500">\r\n<tbody>\r\n<tr>\r\n<td style="width: 148.9pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="199">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">Диапазон   входных напряжений, мВ</span></strong></p>\r\n</td>\r\n<td style="width: 221.6pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="295">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">от 0.03 до   5</span></strong></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.9pt; padding: .75pt .75pt .75pt .75pt;" width="199">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">Чувствительность   (ручная и автоматическая установка), мм/мВ</span></strong></p>\r\n</td>\r\n<td style="width: 221.6pt; padding: .75pt .75pt .75pt .75pt;" width="295">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">5, 12, 20   (± 5%)</span></strong></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.9pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="199">\r\n<p class="MsoNormal"><span style="font-size: 12.0pt; font-family: ">Скорость   подачи, мм/с</span></p>\r\n</td>\r\n<td style="width: 221.6pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="295">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">5, 25, 50   (Строго)</span></strong></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.9pt; padding: .75pt .75pt .75pt .75pt;" width="199">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">Трель /   Импульс</span></strong></p>\r\n</td>\r\n<td style="width: 221.6pt; padding: .75pt .75pt .75pt .75pt;" width="295">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">Да / Да</span></strong></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.9pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="199">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">Ток утечки   пациента, мкA</span></strong></p>\r\n</td>\r\n<td style="width: 221.6pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="295">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">Менее 5</span></strong></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.9pt; padding: .75pt .75pt .75pt .75pt;" width="199">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">Печать</span></strong></p>\r\n</td>\r\n<td style="width: 221.6pt; padding: .75pt .75pt .75pt .75pt;" width="295">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">PC/Laser/Ink-Jet/MTP12/MS25/MS40</span></strong></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.9pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="199">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">Питание от   сети переменного тока, В / Гц</span></strong></p>\r\n</td>\r\n<td style="width: 221.6pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="295">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">28</span></strong></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.9pt; padding: .75pt .75pt .75pt .75pt;" width="199">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">Масса   электрокардиографа, кг</span></strong></p>\r\n</td>\r\n<td style="width: 221.6pt; padding: .75pt .75pt .75pt .75pt;" width="295">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">2,9</span></strong></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.9pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="199">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">Габаритные   размеры (ДхШхВ), мм</span></strong></p>\r\n</td>\r\n<td style="width: 221.6pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="295">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">290x212x69</span></strong></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.9pt; padding: .75pt .75pt .75pt .75pt;" width="199">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">Специальные   тесты</span></strong></p>\r\n</td>\r\n<td style="width: 221.6pt; padding: .75pt .75pt .75pt .75pt;" width="295">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">SIS/ABLB/Тон   в шуме/Тест Stenger</span></strong></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.9pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="199">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">Вес</span></strong></p>\r\n</td>\r\n<td style="width: 221.6pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="295">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: ">2,1 кг</span></strong></p>\r\n</td>\r\n</tr>\r\n</tbody>\r\n</table>\r\n<p class="MsoNormal" style="mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; line-height: normal;"><strong><span style="font-size: 14.0pt; font-family: ">Цена – </span></strong><strong><span style="font-size: 14.0pt; font-family: ">58 200,00</span></strong><strong><span style="font-size: 14.0pt; font-family: "> рублей за штуку.</span></strong></p>\r\n<p class="MsoNormal" style="mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; line-height: normal;"><span style="font-size: 10.5pt; font-family: "> </span></p>\r\n<p class="MsoNormal"> </p>', 'resized/Fotolia_31467_XS_67x90.jpg', 'Fotolia_31467_XS.jpg', 'Y', 0.0000, 'кг.', 0.0000, 0.0000, 0.0000, 'см.', '', 0, 1338854400, '', 'N', 0, NULL, 1338884371, 1339936995, 'Лопаточка с турбоприводом и пилоприбамбасами', 0, '', '', 0, 'шт.', 0, 'N,N,N,N,N,N,20%,10%,', 'none,0,0,1', '', '0,0'),
(23, 1, 0, 'IAD226123', 'Поликлинический аудиометр Поликлинический аудиометр Поликлинический аудиометр', '<p class="MsoNormal" style="mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; text-align: center; line-height: normal;" align="center"><span style="font-size: 10.5pt; font-family: " New="New" New="New">Электрокардиограф CARDIOVIT AT-1 современный прибор для регистрации биоэлектрических потенциалов сердца при диагностике состояния сердечно-сосудистой системы человека.</span></p>\r\n<p class="MsoNormal" style="mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; line-height: normal;"><strong><span style="font-size: 10.5pt; font-family: " New="New" New="New">Характеристики для транспортировки</span></strong><span style="font-size: 10.5pt; font-family: " New="New" New="New"></span></p>\r\n<table class="MsoNormalTable" style="width: 375.0pt; mso-cellspacing: 1.5pt; mso-yfti-tbllook: 1184;" border="0" cellpadding="0" width="500">\r\n<tbody>\r\n<tr>\r\n<td style="width: 148.65pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="198">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">Габариты в   упаковке</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n<td style="width: 221.85pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="296">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">0,28х0,37х0,38</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.65pt; padding: .75pt .75pt .75pt .75pt;" width="198">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">Вес, кг</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n<td style="width: 221.85pt; padding: .75pt .75pt .75pt .75pt;" width="296">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">5</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.65pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="198">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">Объем,   м.куб.</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n<td style="width: 221.85pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="296">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">0.0394</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.65pt; padding: .75pt .75pt .75pt .75pt;" width="198">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">Страна</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n<td style="width: 221.85pt; padding: .75pt .75pt .75pt .75pt;" width="296">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">Швейцария</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.65pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="198">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">Производитель</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n<td style="width: 221.85pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="296">\r\n<p class="MsoNormal"><a href="http://www.medcomp.ru/manufacturer/168/"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">SCHILLER AG</span></strong></a><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n</tr>\r\n</tbody>\r\n</table>\r\n<p class="MsoNormal" style="mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; line-height: normal;"><span style="font-size: 10.5pt; font-family: " New="New" New="New">Возможно хранение в памяти данных ЭКГ (12 сек.), с последующей печатью на термореактивной бумаге шириной 90 мм. В автоматическом режиме одновременно регистрируются 12 стандартных кардиографических отведений через 3 канала оптимизированных для ширины 80 мм. Изолинии настраиваются автоматически.Питание прибора осуществляется от сети переменного тока или от встроенной аккумуляторной батареи. Встроенная батарея аккумуляторов обеспечивает 2 часа работы с функцией печати. Время зарядки батарей - 15 часов при полностью разряженном аккумуляторе (3 часа до 60% заряда). Кабель отведений обеспечивает защиту от импульса дефибриллятора. Звуковая сигнализация сердечного ритма и аварийных ситуаций, наличие индикаторов контроля состояния аккумуляторной батареи и перегрузки усилителя биопотенциалов создают дополнительные удобства при работе с прибором. Наличие индикации показывает: питание от сети или батарей; низкий заряд батарей; отсутствие бумаги или неправильная заправка; состояние фильтра (вкл/выкл); нарушение контакта с электродом. Наличие миографического программируемого и линейного цифрового частотного фильтра обеспечивает высокое качество регистрации электрокардиограмм.</span></p>\r\n<p class="MsoNormal" style="mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; line-height: normal;"><strong><span style="font-size: 10.5pt; font-family: " New="New" New="New">В комплект поставки входят:</span></strong><span style="font-size: 10.5pt; font-family: " New="New" New="New"></span></p>\r\n<ul type="disc">\r\n<li class="MsoNormal" style="color: black; mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; line-height: normal; mso-list: l0 level1 lfo1; tab-stops: list 36.0pt;"><span style="font-size: 10.5pt; font-family: " New="New" New="New">12-проводной кабель пациента;</span></li>\r\n<li class="MsoNormal" style="color: black; mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; line-height: normal; mso-list: l0 level1 lfo1; tab-stops: list 36.0pt;"><span style="font-size: 10.5pt; font-family: " New="New" New="New">4 электрода для конечностей,</span></li>\r\n<li class="MsoNormal" style="color: black; mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; line-height: normal; mso-list: l0 level1 lfo1; tab-stops: list 36.0pt;"><span style="font-size: 10.5pt; font-family: " New="New" New="New">6 грудных грушевидных      электродов,</span></li>\r\n<li class="MsoNormal" style="color: black; mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; line-height: normal; mso-list: l0 level1 lfo1; tab-stops: list 36.0pt;"><span style="font-size: 10.5pt; font-family: " New="New" New="New">электродный гель;</span></li>\r\n<li class="MsoNormal" style="color: black; mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; line-height: normal; mso-list: l0 level1 lfo1; tab-stops: list 36.0pt;"><span style="font-size: 10.5pt; font-family: " New="New" New="New">сетевой кабель;</span></li>\r\n<li class="MsoNormal" style="color: black; mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; line-height: normal; mso-list: l0 level1 lfo1; tab-stops: list 36.0pt;"><span style="font-size: 10.5pt; font-family: " New="New" New="New">упаковка регистрирующей бумаги;</span></li>\r\n<li class="MsoNormal" style="color: black; mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; line-height: normal; mso-list: l0 level1 lfo1; tab-stops: list 36.0pt;"><span style="font-size: 10.5pt; font-family: " New="New" New="New">сумка для транспортировки.</span></li>\r\n</ul>\r\n<p class="MsoNormal" style="mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; line-height: normal;"><strong><span style="font-size: 10.5pt; font-family: " New="New" New="New">Технические характеристики</span></strong><span style="font-size: 10.5pt; font-family: " New="New" New="New"></span></p>\r\n<table class="MsoNormalTable" style="width: 375.0pt; mso-cellspacing: 1.5pt; mso-yfti-tbllook: 1184;" border="0" cellpadding="0" width="500">\r\n<tbody>\r\n<tr>\r\n<td style="width: 148.9pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="199">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">Диапазон   входных напряжений, мВ</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n<td style="width: 221.6pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="295">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">от 0.03 до   5</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.9pt; padding: .75pt .75pt .75pt .75pt;" width="199">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">Чувствительность   (ручная и автоматическая установка), мм/мВ</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n<td style="width: 221.6pt; padding: .75pt .75pt .75pt .75pt;" width="295">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">5, 12, 20   (± 5%)</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.9pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="199">\r\n<p class="MsoNormal"><span style="font-size: 12.0pt; font-family: " New="New" New="New">Скорость   подачи, мм/с</span></p>\r\n</td>\r\n<td style="width: 221.6pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="295">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">5, 25, 50   (Строго)</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.9pt; padding: .75pt .75pt .75pt .75pt;" width="199">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">Трель /   Импульс</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n<td style="width: 221.6pt; padding: .75pt .75pt .75pt .75pt;" width="295">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">Да / Да</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.9pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="199">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">Ток утечки   пациента, мкA</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n<td style="width: 221.6pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="295">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">Менее 5</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.9pt; padding: .75pt .75pt .75pt .75pt;" width="199">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">Печать</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n<td style="width: 221.6pt; padding: .75pt .75pt .75pt .75pt;" width="295">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New">PC/Laser/Ink-Jet/MTP12/MS25/MS40</span></strong><span style="font-size: 12.0pt; font-family: " New="New"></span></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.9pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="199">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">Питание от   сети переменного тока, В / Гц</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n<td style="width: 221.6pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="295">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">28</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.9pt; padding: .75pt .75pt .75pt .75pt;" width="199">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">Масса   электрокардиографа, кг</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n<td style="width: 221.6pt; padding: .75pt .75pt .75pt .75pt;" width="295">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">2,9</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.9pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="199">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">Габаритные   размеры (ДхШхВ), мм</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n<td style="width: 221.6pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="295">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">290x212x69</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.9pt; padding: .75pt .75pt .75pt .75pt;" width="199">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">Специальные   тесты</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n<td style="width: 221.6pt; padding: .75pt .75pt .75pt .75pt;" width="295">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">SIS/ABLB/Тон   в шуме/Тест Stenger</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style="width: 148.9pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="199">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">Вес</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n<td style="width: 221.6pt; background: #CCCCCC; padding: .75pt .75pt .75pt .75pt;" width="295">\r\n<p class="MsoNormal"><strong><span style="font-size: 12.0pt; font-family: " New="New" New="New">2,1 кг</span></strong><span style="font-size: 12.0pt; font-family: " New="New" New="New"></span></p>\r\n</td>\r\n</tr>\r\n</tbody>\r\n</table>\r\n<p class="MsoNormal" style="mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; line-height: normal;"><strong><span style="font-size: 14.0pt; font-family: " New="New" New="New">Цена – </span></strong><strong><span style="font-size: 14.0pt; font-family: " New="New">58 200,00</span></strong><strong><span style="font-size: 14.0pt; font-family: " New="New" New="New"> рублей за штуку.</span></strong><span style="font-size: 10.5pt; font-family: " New="New" New="New"></span></p>\r\n<p class="MsoNormal" style="mso-margin-top-alt: auto; mso-margin-bottom-alt: auto; line-height: normal;"><span style="font-size: 10.5pt; font-family: " New="New" New="New"> </span></p>\r\n<p class="MsoNormal"> </p>', '', '', 'Y', 0.0000, 'кг.', 0.0000, 0.0000, 0.0000, 'см.', '', 0, 1340064000, '', 'N', 0, NULL, 1340080808, 1340081021, 'второй ряд', 0, '', '', 0, 'шт.', 0, 'N,N,N,N,N,N,20%,10%,', 'none,0,0,1', '', '0,0');
...
--
-- Создание: Июн 03 2012 г., 17:01
-- Последнее обновление: Сен 04 2012 г., 11:45
--
...
CREATE TABLE IF NOT EXISTS `jos_vm_product_files` (
  ...
  PRIMARY KEY (`file_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Additional Images and Files which are assigned to products' AUTO_INCREMENT=10 ;

--
-- Дамп данных таблицы `jos_vm_product_files`
--
...
(1, 22, '/components/com_virtuemart/shop_image/product/Fotolia_4446837_XS.jpg', 'Лопаточка', '', 'jpg', 'image/jpeg', 'http://coreatrade.com/paradigm/Puls/components/com_virtuemart/shop_image/product/Fotolia_4446837_XS.jpg', 1, 1, 283, 424, 60, 90),
(2, 22, '/components/com_virtuemart/shop_image/product/1gu63b62.jpg', '', '', 'jpg', 'application/octet-stream', 'http://coreatrade.com/paradigm/Puls/components/com_virtuemart/shop_image/product/1gu63b62.jpg', 1, 1, 375, 500, 67, 90),
(3, 22, '/components/com_virtuemart/shop_image/product/1j4o3d07.jpg', '', '', 'jpg', 'application/octet-stream', 'http://coreatrade.com/paradigm/Puls/components/com_virtuemart/shop_image/product/1j4o3d07.jpg', 1, 1, 375, 500, 67, 90),
(4, 22, '/components/com_virtuemart/shop_image/product/002.JPG', '', '', 'JPG', 'application/octet-stream', 'http://coreatrade.com/paradigm/Puls/components/com_virtuemart/shop_image/product/002.JPG', 1, 1, 333, 500, 60, 90),
(5, 22, '/components/com_virtuemart/shop_image/product/002[4].jpg', '', '', 'jpg', 'application/octet-stream', 'http://coreatrade.com/paradigm/Puls/components/com_virtuemart/shop_image/product/002[4].jpg', 1, 1, 375, 500, 67, 90),
(6, 22, '/components/com_virtuemart/shop_image/product/3d_machines_001.jpg', '', '', 'jpg', 'application/octet-stream', 'http://coreatrade.com/paradigm/Puls/components/com_virtuemart/shop_image/product/3d_machines_001.jpg', 1, 1, 375, 500, 67, 90),
(7, 22, '/components/com_virtuemart/shop_image/product/004.JPG', '', '', 'JPG', 'application/octet-stream', 'http://coreatrade.com/paradigm/Puls/components/com_virtuemart/shop_image/product/004.JPG', 1, 1, 325, 500, 58, 90),
(8, 22, '/components/com_virtuemart/shop_image/product/4-1024.jpg', '', '', 'jpg', 'application/octet-stream', 'http://coreatrade.com/paradigm/Puls/components/com_virtuemart/shop_image/product/4-1024.jpg', 1, 1, 375, 500, 67, 90),
(9, 22, '/components/com_virtuemart/shop_image/product/006.JPG', '', '', 'JPG', 'application/octet-stream', 'http://coreatrade.com/paradigm/Puls/components/com_virtuemart/shop_image/product/006.JPG', 1, 1, 325, 500, 58, 90);
...
--
-- Создание: Июн 03 2012 г., 17:01
-- Последнее обновление: Июн 19 2012 г., 04:40
--
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Holds price records for a product' AUTO_INCREMENT=25 ;
...
(23, 22, 58200.00000, 'RUB', 0, 0, 1339936995, 1339936995, 5, 0, 0),
(18, 18, 140000.00000, 'RUB', 0, 0, 1338736688, 1338883935, 5, 0, 0),
(24, 23, 140000.00000, 'RUB', 0, 0, 1340080808, 1340081021, 5, 0, 0);
...
(62, 1, 5, ''),
(63, 1, 5, '11862445875043c1f72e294');
...
('0a92b51680b3914010f1f597c228b274', 63, 'BT', '-default-', NULL, NULL, '2', '1', '3', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'nowert@mail.ru', NULL, NULL, NULL, NULL, NULL, 1346617846, 1346617846, 'shopper', '', '', '', '', '', 'Checking');
...
--
-- Создание: Июн 03 2012 г., 17:01
-- Последнее обновление: Сен 01 2012 г., 11:52
--
