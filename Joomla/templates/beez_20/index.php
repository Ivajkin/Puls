        ...
        <div id="back">
                <div id="header" style="height: 225px;">
                                <div class="logoheader">
                                        ...
                                        <?php if ($logo): ?>
                                        <a href="index.php"><img src="<?php echo $this->baseurl ?>/<?php echo htmlspecialchars($logo); ?>"  alt="<?php echo htmlspecialchars($templateparams->get('sitetitle'));?>" /></a>
                                        <?php endif;?>
                                        <?php if (!$logo ): ?>
                                        <a href="index.php"><?php echo htmlspecialchars($templateparams->get('sitetitle'));?></a>
                                        <?php endif; ?>
                                        <!--[DESCRIPT]>
                                          <span class="header1">
		  ...
		  <div style="background: #ccc; width: 550px; height: 70px; position: relative; bottom: 50px; display: inline-block;">
		  ...
		  <div id="breadcrumbs" style="position: absolute; top: 100px; left: 250px;">

                                                        <jdoc:include type="modules" name="position-2" />

                                        </div>
		  <div style="width: 200px; position: relative; left: 825px; bottom: 150px; margin-bot: -50px;">
                                        <jdoc:include type="modules" name="position-logform" style="beezDivision" headerLevel="3" />
                                        </div>
                                        <!-- end line -->
