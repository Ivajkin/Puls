...
<div>
  <p><h3>Вход</h3></p>
	<form action="<?php echo $action ?>" method="post" name="login" id="login">
		...
		<br />
		<?php endif; ?>
		<label for="username_vmlogin">Логин<!--<? php echo $VM_LANG->_('USERNAME') ?>--></label>&nbsp&nbsp&nbsp&nbsp&nbsp
		<input class="inputbox" type="text" id="username_vmlogin" size="12" name="username" />
    <p>&nbsp</p>
		<label for="password_vmlogin">Пароль<!--<?php echo $VM_LANG->_('PASSWORD') ?>--></label>&nbsp&nbsp
    ...
    <?php } ?>
		<br />
    <[END]-->
		<input type="submit" value="Войти" class="button" name="Login" /><!--<?php echo $VM_LANG->_('BUTTON_LOGIN') ?>-->
    <!--[START]>
		<ul>
			<li><a href="<?php echo $reset_url ?>">Забыли пароль?<?php echo $VM_LANG->_('LOST_PASSWORD') ?>
      </a></li>
			<?php if( $remind_url ) : ?>
			<li><a href="<?php echo $remind_url ?>">Забыли логин?<?php echo $VM_LANG->_('FORGOT_YOUR_USERNAME') ?></a></li>
			<?php endif; ?>
      <?php if( $mosConfig_allowUserRegistration == '1' ) : ?>
			<li><<?php echo $VM_LANG->_('NO_ACCOUNT') ?><a href="<?php echo $registration_url ?>">Регистрация<?php echo $VM_LANG->_('CREATE_ACCOUNT') ?></a></li>
			<?php endif; ?>
		</ul>
    <[END]-->
  ...
  <p />&nbsp<p><a href="<?php echo $registration_url ?>">Регистрация<!--<?php echo $VM_LANG->_('CREATE_ACCOUNT') ?>--></a></p>
</div>
<?php endif; ?>
