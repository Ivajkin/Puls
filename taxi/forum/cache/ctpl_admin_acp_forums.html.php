...
<?php if ($this->_rootref['S_EDIT_FORUM']) {  ?>
	...
	<?php if (! $this->_rootref['S_FORUM_CAT'] && ! $this->_rootref['S_FORUM_LINK']) {  ?>

	<div id="cleantalk_options">
		<fieldset>
			<legend><?php echo ((isset($this->_rootref['L_CT_SETTINGS_FORUM'])) ? $this->_rootref['L_CT_SETTINGS_FORUM'] : ((isset($user->lang['CT_SETTINGS_FORUM'])) ? $user->lang['CT_SETTINGS_FORUM'] : '{ CT_SETTINGS_FORUM }')); ?></legend>
		<dl>
			<dt><label for="enbale_stoplist_check"><?php echo ((isset($this->_rootref['L_ENABLE_STOPLIST_CHECK'])) ? $this->_rootref['L_ENABLE_STOPLIST_CHECK'] : ((isset($user->lang['ENABLE_STOPLIST_CHECK'])) ? $user->lang['ENABLE_STOPLIST_CHECK'] : '{ ENABLE_STOPLIST_CHECK }')); ?>:</label><br /><span><?php echo ((isset($this->_rootref['L_ENABLE_STOPLIST_CHECK_EXPLAIN'])) ? $this->_rootref['L_ENABLE_STOPLIST_CHECK_EXPLAIN'] : ((isset($user->lang['ENABLE_STOPLIST_CHECK_EXPLAIN'])) ? $user->lang['ENABLE_STOPLIST_CHECK_EXPLAIN'] : '{ ENABLE_STOPLIST_CHECK_EXPLAIN }')); ?></span></dt>
			<dd><label><input type="radio" class="radio" name="enable_stoplist_check" value="1"<?php if ($this->_rootref['S_ENABLE_STOPLIST_CHECK']) {  ?> id="enable_stoplist_check" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></label>
				<label><input type="radio" class="radio" name="enable_stoplist_check" value="0"<?php if (! $this->_rootref['S_ENABLE_STOPLIST_CHECK']) {  ?> id="enable_stoplist_check" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></label></dd>
		</dl>
		<dl>
			<dt><label for="ct_allow_links"><?php echo ((isset($this->_rootref['L_CT_ALLOW_LINKS'])) ? $this->_rootref['L_CT_ALLOW_LINKS'] : ((isset($user->lang['CT_ALLOW_LINKS'])) ? $user->lang['CT_ALLOW_LINKS'] : '{ CT_ALLOW_LINKS }')); ?>:</label><br /><span><?php echo ((isset($this->_rootref['L_CT_ALLOW_LINKS_EXPLAIN'])) ? $this->_rootref['L_CT_ALLOW_LINKS_EXPLAIN'] : ((isset($user->lang['CT_ALLOW_LINKS_EXPLAIN'])) ? $user->lang['CT_ALLOW_LINKS_EXPLAIN'] : '{ CT_ALLOW_LINKS_EXPLAIN }')); ?></span></dt>
			<dd><label><input type="radio" class="radio" name="ct_allow_links" value="1"<?php if ($this->_rootref['S_CT_ALLOW_LINKS']) {  ?> id="ct_allow_links" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></label>
				<label><input type="radio" class="radio" name="ct_allow_links" value="0"<?php if (! $this->_rootref['S_CT_ALLOW_LINKS']) {  ?> id="ct_allow_links" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></label></dd>
		</dl>
		<dl>
			<dt><label for="ct_moderate_registered"><?php echo ((isset($this->_rootref['L_CT_MODERATE_REGISTERED'])) ? $this->_rootref['L_CT_MODERATE_REGISTERED'] : ((isset($user->lang['CT_MODERATE_REGISTERED'])) ? $user->lang['CT_MODERATE_REGISTERED'] : '{ CT_MODERATE_REGISTERED }')); ?>:</label></dt>
			<dd><label><input type="radio" class="radio" name="ct_moderate_registered" value="1"<?php if ($this->_rootref['S_CT_MODERATE_REGISTERED']) {  ?> id="ct_moderate_registered" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></label>
				<label><input type="radio" class="radio" name="ct_moderate_registered" value="0"<?php if (! $this->_rootref['S_CT_MODERATE_REGISTERED']) {  ?> id="ct_moderate_registered" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></label></dd>
		</dl>
		</fieldset>
	</div>
	<?php } ?>
