...
<?php $this->_tpl_include('prime_show_deleted_post.html'); $this->_tpl_include('mods/reimg_content.html'); ?>
	...
	<div id="page-header">
		...
		<div class="navbar">
			...
			<ul class="linklist rightside">
				...
				<?php } if (! $this->_rootref['S_USER_LOGGED_IN'] && ! $this->_rootref['S_IS_BOT'] && $this->_rootref['ULOGIN_ENABLE']) {  ?>

				<li style="margin-top: 5px;">
				<script src="http://ulogin.ru/js/ulogin.js"></script>
				<div id="uLogin" x-ulogin-params="display=small&fields=first_name,last_name,email,photo&optional=bdate,country,city&providers=<?php echo (isset($this->_rootref['ULOGIN_SHOWN'])) ? $this->_rootref['ULOGIN_SHOWN'] : ''; ?>&hidden=<?php echo (isset($this->_rootref['ULOGIN_HIDDEN'])) ? $this->_rootref['ULOGIN_HIDDEN'] : ''; ?>&redirect_uri=<?php echo (isset($this->_rootref['ULOGIN'])) ? $this->_rootref['ULOGIN'] : ''; ?>"></div>
				</li><?php } ?>
