...
<table width="100%" class="center" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="headerwrap"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td class="logowrap"><a href="<?php echo (isset($this->_rootref['U_INDEX'])) ? $this->_rootref['U_INDEX'] : ''; ?>"><img src="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/aktif/spacer.gif" alt="" width="330" height="133" style="border:0px;"/></a></td>
  ...
  <tr>
    <td class="navwrap"><!-- nav buttons bar -->
			...
			<div id="site-description">
				<?php echo (isset($this->_rootref['SITE_DESCRIPTION'])) ? $this->_rootref['SITE_DESCRIPTION'] : ''; ?>
			</div>
