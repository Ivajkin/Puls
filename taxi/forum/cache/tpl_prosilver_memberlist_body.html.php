...
<div class="forumbg forumbg-table">
	...
	<tr class="<?php if (!($_memberrow_val['S_ROW_COUNT'] & 1)  ) {  ?>bg1<?php } else { ?>bg2<?php } ?>">
		...
		<td class="info"><?php if ($_memberrow_val['U_WWW'] || $_memberrow_val['LOCATION']) {  if ($_memberrow_val['U_WWW']) {  ?><div><a href="<?php echo $_memberrow_val['U_WWW']; ?>" <?php echo (isset($this->_rootref['EXTERNAL_LINK_ATTRIBUTES'])) ? $this->_rootref['EXTERNAL_LINK_ATTRIBUTES'] : ''; ?> title="<?php echo ((isset($this->_rootref['L_VISIT_WEBSITE'])) ? $this->_rootref['L_VISIT_WEBSITE'] : ((isset($user->lang['VISIT_WEBSITE'])) ? $user->lang['VISIT_WEBSITE'] : '{ VISIT_WEBSITE }')); ?>: <?php echo $_memberrow_val['U_WWW']; ?>"><?php echo $_memberrow_val['U_SHORT_WWW']; ?></a></div><?php } if ($_memberrow_val['LOCATION']) {  ?><div><?php echo $_memberrow_val['LOCATION']; ?></div><?php } } else { ?>&nbsp;<?php } ?></td>
