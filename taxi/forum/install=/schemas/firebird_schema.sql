#
# $Id: firebird_schema.sql 10462 2010-01-28 23:15:25Z bantu $
#
...
CREATE TABLE phpbb_forums (
	...
	enable_stoplist_check INTEGER DEFAULT 0 NOT NULL,
	ct_moderate_guests INTEGER DEFAULT 0 NOT NULL,
	ct_moderate_newly_registered INTEGER DEFAULT 0 NOT NULL,
	ct_moderate_registered INTEGER DEFAULT 0 NOT NULL,
	ct_allow_links INTEGER DEFAULT 0 NOT NULL
);;
...
CREATE TABLE phpbb_posts (
	...
	ct_request_id CHAR(32) CHARACTER SET NONE DEFAULT '' NOT NULL
);;
...
CREATE TABLE phpbb_profile_fields (
	...
	field_stats_show INTEGER NOT NULL DEFAULT 0
);;
...
CREATE TABLE phpbb_topics (
	...
	topic_deleted_from INTEGER DEFAULT 0 NOT NULL,
	topic_deleted_user INTEGER DEFAULT 0 NOT NULL,
	topic_deleted_time INTEGER DEFAULT 0 NOT NULL,
	topic_deleted_reason VARCHAR(255) CHARACTER SET UTF8 DEFAULT '' NOT NULL COLLATE UNICODE,
...
CREATE INDEX phpbb_topics_altt ON phpbb_topics(topic_last_post_id);;
...
CREATE TABLE phpbb_users (
	...
	user_reputation INTEGER DEFAULT 0 NOT NULL,
	user_hide_reputation INTEGER  DEFAULT 0 NOT NULL,
	user_allow_thanks_pm INTEGER  DEFAULT 0 NOT NULL,
	ct_request_id CHAR(32) CHARACTER SET NONE DEFAULT '' NOT NULL
);;
...
CREATE TABLE phpbb_reputations (
  ...
  rep_from INTEGER NOT NULL DEFAULT 0,
  rep_to INTEGER NOT NULL DEFAULT 0,
  rep_time INTEGER NOT NULL DEFAULT 0,
  rep_post_id INTEGER NOT NULL DEFAULT 0,
  rep_point INTEGER NOT NULL DEFAULT 0,
  rep_comment BLOB SUB_TYPE TEXT CHARACTER SET UTF8 NOT NULL COLLATE UNICODE,
  bbcode_uid VARCHAR(8) CHARACTER SET UTF8 DEFAULT '' NOT NULL COLLATE UNICODE,
  bbcode_bitfield VARCHAR(255) CHARACTER SET UTF8 DEFAULT '' NOT NULL COLLATE UNICODE,
  enable_bbcode INTEGER NOT NULL DEFAULT 1,
  enable_smilies INTEGER NOT NULL DEFAULT 1,
  enable_urls INTEGER NOT NULL DEFAULT 1,
  rep_ip_address VARCHAR(40) CHARACTER SET UTF8 DEFAULT '' NOT NULL COLLATE UNICODE,
  username VARCHAR(255) CHARACTER SET UTF8 DEFAULT '' NOT NULL COLLATE UNICODE
);;

ALTER TABLE phpbb_reputations ADD PRIMARY KEY (rep_id);;

CREATE GENERATOR phpbb_reputations_gen;;
SET GENERATOR phpbb_reputations_gen TO 0;;

CREATE TRIGGER t_phpbb_reputations FOR phpbb_reputations
BEFORE INSERT
AS
BEGIN
	NEW.rep_id = GEN_ID(phpbb_reputations_gen, 1);
END;;

CREATE TABLE phpbb_reputations_ranks (
  rank_id INTEGER DEFAULT 0 NOT NULL,
  rank_title VARCHAR(255) CHARACTER SET UTF8 DEFAULT '' NOT NULL COLLATE UNICODE,
  rank_points INTEGER DEFAULT 0 NOT NULL
);;

ALTER TABLE phpbb_reputations_ranks ADD PRIMARY KEY (rank_id);;

CREATE GENERATOR phpbb_reputations_ranks_gen;;
SET GENERATOR phpbb_reputations_ranks_gen TO 0;;

CREATE TRIGGER t_phpbb_reputations_ranks FOR phpbb_reputations_ranks
BEFORE INSERT
AS
BEGIN
	NEW.rank_id = GEN_ID(phpbb_reputations_ranks_gen, 1);
END;;

CREATE TABLE phpbb_ulogin (
  id INTEGER NOT NULL,
  userid INTEGER DEFAULT 0 NOT NULL,
  identity BLOB SUB_TYPE TEXT CHARACTER SET UTF8 DEFAULT '' NOT NULL
);;

ALTER TABLE phpbb_ulogin ADD PRIMARY KEY (id);;


CREATE GENERATOR phpbb_ulogin_gen;;
SET GENERATOR phpbb_ulogin_gen TO 0;;

CREATE TRIGGER t_phpbb_ulogin FOR phpbb_ulogin
BEFORE INSERT
AS
BEGIN
	NEW.id = GEN_ID(phpbb_ulogin_gen, 1);
END;;