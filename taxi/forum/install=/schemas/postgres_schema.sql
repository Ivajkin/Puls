...
CREATE TABLE phpbb_forums (
	...
	enable_stoplist_check INT2 DEFAULT '0' NOT NULL CHECK (enable_stoplist_check >= 0),
	ct_moderate_guests INT2 DEFAULT '0' NOT NULL CHECK (ct_moderate_guests >= 0),
	ct_moderate_newly_registered INT2 DEFAULT '0' NOT NULL CHECK (ct_moderate_newly_registered >= 0),
	ct_moderate_registered INT2 DEFAULT '0' NOT NULL CHECK (ct_moderate_registered >= 0),
	ct_allow_links INT2 DEFAULT '0' NOT NULL CHECK (ct_allow_links >= 0),
...
CREATE TABLE phpbb_posts (
	...
	post_deleted_from INT4 DEFAULT '0' NOT NULL,
	post_deleted_user INT4 DEFAULT '0' NOT NULL,
	post_deleted_time INT4 DEFAULT '0' NOT NULL,
	post_deleted_reason varchar(255) DEFAULT '' NOT NULL,
...
CREATE TABLE phpbb_profile_fields (
	...
	field_stats_show INT2 NOT NULL DEFAULT '0',
...
CREATE TABLE phpbb_topics (
	...
	topic_deleted_from INT4 DEFAULT '0' NOT NULL,
	topic_deleted_user INT4 DEFAULT '0' NOT NULL,
	topic_deleted_time INT4 DEFAULT '0' NOT NULL,
	topic_deleted_reason varchar(255) DEFAULT '' NOT NULL,
	topic_first_post_show INT2 DEFAULT '0' NOT NULL,
...
CREATE TABLE phpbb_users (
	...
	user_reputation INT4 DEFAULT '0' NOT NULL,
	user_hide_reputation INT2 DEFAULT '0' NOT NULL,
	user_allow_thanks_pm INT2 DEFAULT '0' NOT NULL,
	ct_request_id char(32) DEFAULT '' NOT NULL,
	PRIMARY KEY (user_id)
);
...
CREATE TABLE phpbb_reputations (
  rep_id INT4 DEFAULT nextval('phpbb_reputations_seq'),
  rep_from INT4 NOT NULL DEFAULT '0',
  rep_to INT4 NOT NULL DEFAULT '0',
  rep_time INT4 NOT NULL DEFAULT '0',
  rep_post_id INT4 NOT NULL DEFAULT '0',
  rep_point INT4 NOT NULL DEFAULT '0',
  rep_comment TEXT NOT NULL DEFAULT '',
  bbcode_uid varchar(8) NOT NULL DEFAULT '',
  bbcode_bitfield varchar(255) NOT NULL DEFAULT '',
  enable_bbcode INT2 NOT NULL DEFAULT '1',
  enable_smilies INT2 NOT NULL DEFAULT '1',
  enable_urls INT2 NOT NULL DEFAULT '1',
  rep_ip_address varchar(40) NOT NULL DEFAULT '',
  username varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY (rep_id)
);

CREATE SEQUENCE phpbb_reputations_ranks_seq;

CREATE TABLE phpbb_reputations_ranks (
  rank_id INT4 DEFAULT nextval('phpbb_reputations_ranks_seq'),
  rank_title varchar(255) NOT NULL DEFAULT '',
  rank_points INT4 NOT NULL DEFAULT '0',
  PRIMARY KEY (rank_id)
);

CREATE SEQUENCE phpbb_ulogin_seq;
CREATE TABLE phpbb_ulogin (
  id  INT4 DEFAULT '0' NOT NULL CHECK (id >= 0),
  userid  INT4 DEFAULT '0' NOT NULL CHECK (userid >= 0),
  identity varchar(4000) DEFAULT '' NOT NULL,
  PRIMARY KEY (id)
);
COMMIT;