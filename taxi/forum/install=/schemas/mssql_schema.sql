/*
 ...
 $Id: mssql_schema.sql 10462 2010-01-28 23:15:25Z bantu $
...
CREATE TABLE [phpbb_forums] (
	...
	[enable_stoplist_check] [int] DEFAULT (0) NOT NULL,
	[ct_moderate_guests] [int] DEFAULT (0) NOT NULL,
	[ct_moderate_newly_registered] [int] DEFAULT (0) NOT NULL,
	[ct_moderate_registered] [int] DEFAULT (0) NOT NULL,
	[ct_allow_links] [int] DEFAULT (0) NOT NULL
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
...
CREATE TABLE [phpbb_posts] (
	...
	[post_deleted_from] [int] DEFAULT (0) NOT NULL ,
	[post_deleted_user] [int] DEFAULT (0) NOT NULL ,
	[post_deleted_time] [int] DEFAULT (0) NOT NULL ,
	[post_deleted_reason] [varchar] (255) DEFAULT ('') NOT NULL,
	[ct_request_id] [varchar] (32) DEFAULT ('') NOT NULL
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
...
CREATE TABLE [phpbb_profile_fields] (
	...
	[field_stats_show] [int] DEFAULT (0) NOT NULL
) ON [PRIMARY]
GO
...
CREATE TABLE [phpbb_topics] (
	...
	[topic_deleted_from] [int] DEFAULT (0) NOT NULL,
	[topic_deleted_user] [int] DEFAULT (0) NOT NULL,
	[topic_deleted_time] [int] DEFAULT (0) NOT NULL,
...
CREATE  INDEX [altt] ON [phpbb_topics]([topic_last_post_id]) ON [PRIMARY]
GO
...
CREATE TABLE [phpbb_users] (
	...
	[user_reputation] [int] DEFAULT (0) NOT NULL,
	[user_hide_reputation] [int] DEFAULT (0) NOT NULL,
	[user_allow_thanks_pm] [int] DEFAULT (0) NOT NULL,
	[ct_request_id] [varchar] (32) DEFAULT ('') NOT NULL
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
...
CREATE TABLE phpbb_reputations (
  [rep_id] [int] DEFAULT (0) NOT NULL ,
  [rep_from] [int] DEFAULT (0) NOT NULL ,
  [rep_to] [int] DEFAULT (0) NOT NULL ,
  [rep_time] [int] DEFAULT (0) NOT NULL ,
  [rep_post_id] [int] DEFAULT (0) NOT NULL ,
  [rep_point] [int] DEFAULT (0) NOT NULL ,
  [rep_comment] [text] NOT NULL,
  [bbcode_uid] [varchar](8) NOT NULL DEFAULT (''),
  [bbcode_bitfield] [varchar](255) NOT NULL DEFAULT (''),
  [enable_bbcode] [int] DEFAULT (1) NOT NULL ,
  [enable_smilies] [int] DEFAULT (1) NOT NULL ,
  [enable_urls] [int] DEFAULT (1) NOT NULL ,
  [rep_ip_address] [varchar](40) NOT NULL DEFAULT (''),
  [username] [varchar](255) NOT NULL DEFAULT ('')
)
GO

ALTER TABLE [phpbb_reputations] WITH NOCHECK ADD
	CONSTRAINT [PK_phpbb_reputations] PRIMARY KEY  CLUSTERED
	(
		[rep_id]
	)  ON [PRIMARY]
GO
...
ALTER TABLE [phpbb_reputations_ranks] WITH NOCHECK ADD
	CONSTRAINT [PK_phpbb_reputations_ranks] PRIMARY KEY  CLUSTERED
	(
		[rank_id]
	)  ON [PRIMARY]
GO
...
ALTER TABLE [phpbb_ulogin] WITH NOCHECK ADD 
	CONSTRAINT [PK_phpbb_ulogin] PRIMARY KEY  CLUSTERED 
	(
		[id]
	)  ON [PRIMARY] 
GO
