...
CREATE TABLE phpbb_forums (
	...
	enable_stoplist_check number(1) DEFAULT '0' NOT NULL,
	ct_moderate_guests number(1) DEFAULT '0' NOT NULL,
	ct_moderate_newly_registered number(1) DEFAULT '0' NOT NULL,
	ct_moderate_registered tinyint(1) number(1) DEFAULT '0' NOT NULL,
	ct_allow_links number(1) DEFAULT '0' NOT NULL,
...
CREATE TABLE phpbb_posts (
	...
	post_deleted_from number(8) DEFAULT '0' NOT NULL,
	post_deleted_user number(8) DEFAULT '0' NOT NULL,
	post_deleted_time number(11) DEFAULT '0' NOT NULL,
	post_deleted_reason varchar2(255) DEFAULT '' NOT NULL,
	ct_request_id char(32) DEFAULT '' NOT NULL,
...
CREATE TABLE phpbb_profile_fields (
	...
	field_stats_show number(1) NOT NULL DEFAULT '0',
...
CREATE TABLE phpbb_topics (
	...
	topic_deleted_from number(8) DEFAULT '0' NOT NULL,
	topic_deleted_user number(8) DEFAULT '0' NOT NULL,
	topic_deleted_time number(11) DEFAULT '0' NOT NULL,
	topic_deleted_reason varchar2(255) DEFAULT '' NOT NULL,
...
CREATE TABLE phpbb_users (
	...
	user_reputation number(11) DEFAULT '0' NOT NULL,
	user_hide_reputation number(1) DEFAULT '0' NOT NULL,
	user_allow_thanks_pm number(1) DEFAULT '0' NOT NULL,
	ct_request_id char(32) DEFAULT '' NOT NULL,
...
CREATE TABLE phpbb_reputations (
  rep_id number(8)  NOT NULL,
  rep_from number(8) DEFAULT '0' NOT NULL,
  rep_to number(8) DEFAULT '0' NOT NULL,
  rep_time number(11) DEFAULT '0' NOT NULL,
  rep_post_id number(8) DEFAULT '0' NOT NULL,
  rep_point number(1) DEFAULT '0' NOT NULL,
  rep_comment clob NOT NULL,
  bbcode_uid varchar2(8) NOT NULL DEFAULT '',
  bbcode_bitfield varchar2(255) NOT NULL DEFAULT '',
  enable_bbcode number(1) DEFAULT '1' NOT NULL,
  enable_smilies number(1) DEFAULT '1' NOT NULL,
  enable_urls number(1) DEFAULT '1' NOT NULL,
  rep_ip_address varchar2(40) NOT NULL DEFAULT '',
  username varchar2(255) NOT NULL DEFAULT '',
  CONSTRAINT pk_phpbb_reputations PRIMARY KEY (rep_id)
)
/

CREATE SEQUENCE phpbb_reputations_seq
/

CREATE OR REPLACE TRIGGER t_phpbb_reputations
BEFORE INSERT ON phpbb_reputations
FOR EACH ROW WHEN (
	new.rep_id IS NULL OR new.rep_id = 0
)
BEGIN
	SELECT phpbb_reputations_seq.nextval
	INTO :new.rep_id
	FROM dual;
END;
/
...
CREATE TABLE phpbb_reputations_ranks (
  rank_id number(8)  NOT NULL,
  rank_title varchar2(255) NOT NULL DEFAULT '',
  rank_points number(11) DEFAULT '0' NOT NULL,
  CONSTRAINT pk_phpbb_reputations_ranks PRIMARY KEY (rank_id)
)
/

CREATE SEQUENCE phpbb_reputations_ranks
/

CREATE OR REPLACE TRIGGER t_phpbb_reputations_ranks
BEFORE INSERT ON phpbb_reputations_ranks
FOR EACH ROW WHEN (
	new.rank_id IS NULL OR new.rank_id = 0
)
BEGIN
	SELECT phpbb_reputations_ranks.nextval
	INTO :new.rank_id
	FROM dual;
END;
/
...
CREATE TABLE phpbb_ulogin (
  ...
  identity varchar2(3000),
  CONSTRAINT pk_phpbb_ulogin PRIMARY KEY (id)
)
/

CREATE SEQUENCE phpbb_ulogin_seq
/

CREATE OR REPLACE TRIGGER t_phpbb_ulogin
BEFORE INSERT ON phpbb_ulogin
FOR EACH ROW WHEN (
	new.id IS NULL OR new.id = 0
)
BEGIN
	SELECT phpbb_ulogin_seq.nextval
	INTO :new.id
	FROM dual;
END;
/