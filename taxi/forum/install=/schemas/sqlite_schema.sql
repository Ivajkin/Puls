#
# $Id: sqlite_schema.sql 10462 2010-01-28 23:15:25Z bantu $
#
...
CREATE TABLE phpbb_forums (
	...
	enable_stoplist_check INTEGER UNSIGNED NOT NULL DEFAULT '0',
	ct_moderate_guests INTEGER UNSIGNED NOT NULL DEFAULT '0',
	ct_moderate_newly_registered INTEGER UNSIGNED NOT NULL DEFAULT '0',
	ct_moderate_registered INTEGER UNSIGNED NOT NULL DEFAULT '0',
	ct_allow_links INTEGER UNSIGNED NOT NULL DEFAULT '0'
);
...
CREATE TABLE phpbb_groups (
	...
	group_reputation_power INTEGER UNSIGNED DEFAULT '0' NOT NULL
);
...
CREATE TABLE phpbb_posts (
	...
	post_deleted_from INTEGER UNSIGNED DEFAULT '0' NOT NULL,
	post_deleted_user INTEGER UNSIGNED DEFAULT '0' NOT NULL,
	post_deleted_time int(11) UNSIGNED DEFAULT '0' NOT NULL,
...
CREATE TABLE phpbb_profile_fields (
	...
	field_stats_show INTEGER UNSIGNED NOT NULL DEFAULT '0'
);
...
CREATE TABLE phpbb_topics (
	...
	topic_deleted_from INTEGER UNSIGNED DEFAULT '0' NOT NULL,
	topic_deleted_user INTEGER UNSIGNED DEFAULT '0' NOT NULL,
	topic_deleted_time int(11) UNSIGNED DEFAULT '0' NOT NULL,
	topic_deleted_reason varchar(255) DEFAULT '' NOT NULL,
	topic_first_post_show INTEGER UNSIGNED DEFAULT '0' NOT NULL
);
...
CREATE TABLE phpbb_users (
	...
	user_hide_reputation INTEGER UNSIGNED DEFAULT '0' NOT NULL,
	user_allow_thanks_pm INTEGER UNSIGNED DEFAULT '0' NOT NULL,
	ct_request_id char(32) DEFAULT '' NOT NULL
);
...
CREATE TABLE phpbb_reputations (
  ...
  rep_from INTEGER UNSIGNED NOT NULL DEFAULT '0',
  rep_to INTEGER UNSIGNED NOT NULL DEFAULT '0',
  rep_time int(11) UNSIGNED NOT NULL DEFAULT '0',
  rep_post_id INTEGER UNSIGNED NOT NULL DEFAULT '0',
  rep_point int(11) NOT NULL DEFAULT '0',
  rep_comment mediumtext(16777215) NOT NULL DEFAULT '',
  bbcode_uid varchar(8) NOT NULL DEFAULT '',
  bbcode_bitfield varchar(255) NOT NULL DEFAULT '',
  enable_bbcode INTEGER UNSIGNED NOT NULL DEFAULT '1',
  enable_smilies INTEGER UNSIGNED NOT NULL DEFAULT '1',
  enable_urls INTEGER UNSIGNED NOT NULL DEFAULT '1',
