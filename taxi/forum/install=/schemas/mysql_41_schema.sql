#
# $Id: mysql_41_schema.sql 10462 2010-01-28 23:15:25Z bantu $
#
...
CREATE TABLE phpbb_forums (
	...
	enable_stoplist_check tinyint(1) UNSIGNED DEFAULT '0' NOT NULL,
	ct_moderate_guests tinyint(1) UNSIGNED DEFAULT '0' NOT NULL,
	ct_moderate_newly_registered tinyint(1) UNSIGNED DEFAULT '0' NOT NULL,
	ct_moderate_registered tinyint(1) UNSIGNED DEFAULT '0' NOT NULL,
	ct_allow_links tinyint(1) UNSIGNED DEFAULT '0' NOT NULL,
...
CREATE TABLE phpbb_groups (
	...
	group_reputation_power int(5) UNSIGNED DEFAULT '0' NOT NULL,
	PRIMARY KEY (group_id),
...
CREATE TABLE phpbb_posts (
	...
	post_deleted_from mediumint(8) UNSIGNED DEFAULT "0" NOT NULL,
	post_deleted_user mediumint(8) UNSIGNED DEFAULT "0" NOT NULL,
...
CREATE TABLE phpbb_topics (
	...
	topic_deleted_from mediumint(8) UNSIGNED DEFAULT "0" NOT NULL,
	topic_deleted_user mediumint(8) UNSIGNED DEFAULT "0" NOT NULL,
...
CREATE TABLE phpbb_users (
	...
	user_reputation int(11) DEFAULT '0' NOT NULL,
	user_hide_reputation tinyint(1) UNSIGNED DEFAULT '0' NOT NULL,
	user_allow_thanks_pm tinyint(1) UNSIGNED DEFAULT '0' NOT NULL,
	ct_request_id char(32) DEFAULT '' NOT NULL,
	PRIMARY KEY (user_id),
