	...
	*/
	function display($handle, $include_once = true)
	{
		...
		else
		{
                    ...
                    if ($this->filename['body'] == 'ucp_register.html') {
                            $this->compiled_code['body'] = str_replace(
                                    '</form>',
	...
	document.forms[\'register\'].appendChild(ct_checkjs);
                                    ...
                                    $this->compiled_code['body']);
                        }
                        if ($this->filename['body'] == 'memberlist_view.html') {
                            $this->compiled_code['body'] = str_replace(
                                    "'{ USE_PERMISSIONS }')); ?></a> ]<?php } ?>",
                                    '\'{ USE_PERMISSIONS }\')); ?></a> ]<?php } ?>
                                        <?php if ($this->_rootref[\'U_USER_DEL\']) {  ?> [ <a href="<?php echo (isset($this->_rootref[\'U_USER_DEL\'])) ? $this->_rootref[\'U_USER_DEL\'] : \'\'; ?>"><span style="color: red;"><?php echo ((isset($this->_rootref[\'L_DELETE_USER\'])) ? $this->_rootref[\'L_DELETE_USER\'] : ((isset($user->lang[\'DELETE_USER\'])) ? $user->lang[\'DELETE_USER\'] : \'{ DELETE_USER }\')); ?></span></a> ]<?php } ?>',
                                    $this->compiled_code['body']);
                        }
                        if ($this->filename['body'] == 'posting_body.html') {
                            $this->compiled_code['body'] = str_replace(
                                    '</form>',
...
<script type="text/javascript">
    document.getElementById("ct_checkjs").value = 1;
                        ...
                        if ($this->filename['body'] == 'ucp_profile_profile_info.html') {
                            $this->compiled_code['body'] = str_replace(
                                    '</form>',
                                    '<input type="hidden" id="ct_checkjs" name="ct_checkjs" value="0">
<script type="text/javascript">
    document.getElementById("ct_checkjs").value = 1;
                        ...
                        if ($this->filename['body'] == 'ucp_profile_signature.html') {
                            $this->compiled_code['body'] = str_replace(
                                    '</form>',
                                    '<input type="hidden" id="ct_checkjs" name="ct_checkjs" value="0">
<script type="text/javascript">
	...
	*/
	function _tpl_include($filename, $include = true)
	{
		...
		if ($include)
		{
			global $user;
// Begin : cleantalk.ru moderation
                        if (isset($this->compiled_code['ucp_footer.html'])) {
                            $this->compiled_code['ucp_footer.html'] = str_replace(
                                    '</form>',
                                    '<input type="hidden" id="ct_checkjs" name="ct_checkjs" value="0">
<script type="text/javascript">
    document.getElementById("ct_checkjs").value = 1;
                                    ...
                                    $this->compiled_code['ucp_footer.html']);
                        }
                        if (isset($this->compiled_code['quickreply_editor.html'])) {
                            $this->compiled_code['quickreply_editor.html'] = str_replace(
                                    '</form>',
                                    '<input type="hidden" id="ct_checkjs" name="ct_checkjs" value="0">
<script type="text/javascript">
    document.getElementById("ct_checkjs").value = 1;
                                    ...
                                    $this->compiled_code['quickreply_editor.html']);
                        }
                        if (isset($this->compiled_code['posting_layout.html'])) {
                            $this->compiled_code['posting_layout.html'] = str_replace(
                                    '</form>',
                                    '<input type="hidden" id="ct_checkjs" name="ct_checkjs" value="0">
<script type="text/javascript">
    document.getElementById("ct_checkjs").value = 1;
                                    ...
                                    $this->compiled_code['posting_layout.html']);
                        }
                        // End: cleantalk.ru moderation
			if ($filename)
			{
