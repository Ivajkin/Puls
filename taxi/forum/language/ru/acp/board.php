...
$lang = array_merge($lang, array(
	...
	'MAX_FILESIZE_EXPLAIN'				=> 'Для загружаемых файлов аватар. Если установлено значение 0, размер загружаемых файлов ограничивается только конфигурацией PHP.',
...
$lang = array_merge($lang, array(
	...
	'ENABLE_ULOGIN'						=> 'Включить мод Ulogin',
	'ENABLE_ULOGIN_EXPLAIN'				=> 'Если выключено, доступен вход через штатный механизм форума. <em>Примечание: данная опция должна быть включена, если вы хотите активировать вход на форум через сервис Ulogin с использованием доступ от других сервисов: Google, Яндекс, Вконтакте и т.д..</em>',
