...
$lang = array_merge($lang, array(
	...
	'ACP_ULOGIN_SETTINGS'				=> 'Настройки мода Ulogin',
...
$lang = array_merge($lang, array(
	...
	'INACTIVE_USERS_EXPLAIN_INDEX'		=> 'Ниже находится список десяти последних зарегистрированных пользователей, имеющих неактивные аккаунты. Аккаунты являются неактивными потому, что в настройках регистрации пользователей включена активация пользовательских аккаунтов и эти аккаунты пока не были активированы, или эти аккаунты были отключены. Полный список аккаунтов доступен по ссылке внизу. Также, перейдя по ссылке, Вы сможете активировать аккаунты, удалить их, или отправить напоминание выбранным пользователям (посредством e-mail).',
...
$lang = array_merge($lang, array(
	...
	'LOG_CONFIG_ULOGIN'				=> '<strong>Изменены настройки мода ULogin</strong>',
