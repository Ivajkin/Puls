...
$lang = array_merge($lang, array(
	...
	'DELETE_USER_EXPLAIN'		=> 'Учтите, что удаление пользователя необратимо, он не может быть восстановлен. Непрочитанные личные сообщения, которые были отправлены данным пользователем, также будут удалены и не будут доступны получателям.',
	...
	'USER_NO_POSTS_TO_DELETE'			=> 'У пользователя нет сообщений для сохранения или удаления.',
