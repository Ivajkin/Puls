...
$lang = array_merge($lang, array(
	...
	'ATTACH_MAX_FILESIZE_EXPLAIN'			=> 'Максимальный размер каждого загружаемого файла. Если установлено значение 0, размер загружаемых файлов ограничивается только конфигурацией PHP.',
