...
$lang = array_merge($lang, array(
	...
	'SMILIE_NO_FILE'			=> 'Смайлик «%s» не был добавлен, так как файл не был обнаружен.',
...
// Disallow Usernames
$lang = array_merge($lang, array(
	'ACP_DISALLOW_EXPLAIN'	=> 'Здесь Вы можете управлять именами пользователей, запрещенными для использования. Запрещенные имена могут содержать подстановочные знаки (*).',
	...
	'DISALLOWED_ALREADY'		=> 'Указанное имя уже запрещено.',
