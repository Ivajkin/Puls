...
$lang = array_merge($lang, array(
	...
	'MERGE_POSTS_CONFIRM'	=> 'Вы уверены что хотите переместить выбранное сообщение?',
	'MERGE_TOPIC_EXPLAIN'	=> 'Используя данную форму Вы можете переместить данное сообщение в другую тему. Сообщение будет удалено с данной темы и вставлено в другую тему. Это сообщение не будет записано и будет отображаться как будто пользователь только что оставил его в новой теме.<br />Пожалуйста, укажите id конечной темы или нажмите “Выбрать тему”, чтобы найти необходимую Вам.',
