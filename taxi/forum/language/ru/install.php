...
$lang = array_merge($lang, array(
	...
	'BACKUP_NOTICE'						=> 'Пожалуйста, сделайте бэкап форума перед обновлением. Это даст Вам возможность восстановить форум в случае возникновения пороблем.',
	...
	'DB_HOST_EXPLAIN'				=> 'DSN - имя источника данных при установке с использованием ODBC. В PostgreSQL используйте имя localhost для соединения с локальным сервером через сокет домена UNIX или адрес 127.0.0.1 для соединения через TCP. Для SQLite, введите полный путь к файлу базы данных.',
...
<p>В списке выбора типа базы данных будут отображаться лишь те, которые поддерживает Ваш сервер.',
	...
	'INST_ERR_DB_INVALID_PREFIX'=> 'Префикс введен неверно. Он должен начинаться с алфавитно-цифровых символов и должен содержать только буквенно-цифровые символы, цифры и символы подчеркивания.',
...
Также Вы можете прочесть <a href="http://bb3x.ru/a_main/main_install" target="_blank">статью "Установка форума"</a>, которая содержит более простое и понятное пошаговое описание процесса установки.<br /><br /><br /><br />Чтобы прочесть о лицензии phpBB3 и ознакомиться с информацией о получении поддержки, пожалуйста, кликните по соответствующей ссылке в боковом меню. Для продолжения кликните на соответствующей закладке вверху страницы. Для получения русскоязычной поддержки Вы можете использовать портал <a href="http://bb3x.ru/" target="_blank">Русской поддержки phpBB3</a>.',
	...
	'TABLE_PREFIX_EXPLAIN'		=> 'Префикс должен начинаться с алфавитно-цифровых символов и должен содержать только буквенно-цифровые символы, цифры и символ подчеркивания.',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'Все файлы соответствуют самой последней версии phpBB. Теперь <a href="../ucp.php?mode=login"> войдите на форум</a> и проверьте, чтобы всё работало корректно. Не забудьте удалить, переименовать или переместить папку «install»! Пожалуйста, отправьте нам обновлённую информацию о Вашем сервере и форуме с помощью страницы <a href="../ucp.php?mode=login&amp;redirect=adm/index.php%3Fi=send_statistics%26mode=send_statistics"> отправки статистической информации</a> в Центре администрирования.',
...
$lang = array_merge($lang, array(
	...
	'CT_TOPICS_TOPIC_TITLE'				=> 'Защита от спама',
	'CT_DEFAULT_INSTALL_POST'			=> '[size=150:9vhy96t9][b:9vhy96t9]На форуме установлен модуль защиты форума от спама CleanTalk[/b:9vhy96t9][/size:9vhy96t9]

	Модуль защищает форум от регистрации спам ботов, автоматического и ручного спама в
темах форума. Для проверки сообщений используется сервис защиты от спама [url=http&#58;//cleantalk&#46;ru?partner_id=979:9vhy96t9]cleantalk.ru[/url:9vhy96t9].

[size=150:9vhy96t9][b:9vhy96t9]Настройка и активация защиты[/b:9vhy96t9][/size:9vhy96t9]

1. Для активации модуля зарегистрируйтесь и получите Ключ доступа,
[url=http&#58;//cleantalk&#46;ru/install/phpbb3?step=2&amp;partner_id=979:9vhy96t9]http://cleantalk.ru/install/phpbb3?step=2[/url:9vhy96t9]

2. Полученный Ключ укажите в настройках модуля,
[code:9vhy96t9]
Центр администрирования -&gt; CLEANTALK -&gt; Настройки
[/code:9vhy96t9]

[img:9vhy96t9]http&#58;//bb3x&#46;ru/files/mod2&#46;jpg[/img:9vhy96t9]

3. На этой же странице установите переключатель &quot;[b:9vhy96t9]Включить модуль[/b:9vhy96t9]&quot; в положение &quot;[b:9vhy96t9]Да[/b:9vhy96t9]&quot;.

4. Протестируйте работу модуля в соответствии с инструкцией разработчика,
[url=http&#58;//cleantalk&#46;ru/install/phpbb3?step=4&amp;partner_id=979:9vhy96t9]http://cleantalk.ru/install/phpbb3?step=4[/url:9vhy96t9]

На этом настройка закончена! Вопросы по работе модуля можно обсудить на форуме bb3x.ru,
[url=http&#58;//forum&#46;bb3x&#46;ru/topic-7726:9vhy96t9]CleanTalk. Модуль защиты phpBB3 от спама[/url:9vhy96t9]

[size=150:9vhy96t9][b:9vhy96t9]Желаем приятной работы с прекрасным форумом phpBB3![/b:9vhy96t9][/size:9vhy96t9]

[b:9vhy96t9]PS[/b:9vhy96t9]
Воспользовавшись промо-кодом &quot;bb3x_user&quot; Вы получите [b:9vhy96t9]скидку 5%[/b:9vhy96t9] на платные тарифы компании CleanTalk!',
));
