...
$lang = array_merge($lang, array(
	...
	'ENABLE_ULOGIN'					=> 'Enable mod Ulogin',
	'ENABLE_ULOGIN_EXPLAIN'			=> 'If disabled, the input is available through the regular mechanism of the forum. <em> Note: This option must be enabled, if you wish to activate the entrance to the forum via Ulogin service with access to other services: Google, Yandex, MySpace and so on. </em>',
