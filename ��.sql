...
--
-- Хост: 127.0.0.1
-- Время создания: Май 04 2012 г., 00:47
...
-- База данных: `maindb`
--
CREATE DATABASE `maindb` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `maindb`;

-- --------------------------------------------------------

--
-- Структура таблицы `joomla_assets`
--
...
--
-- Дамп данных таблицы `joomla_assets`
--
...
--
-- Структура таблицы `joomla_associations`
--
...
--
-- Структура таблицы `joomla_banner_clients`
--
...
--
-- Дамп данных таблицы `joomla_banner_clients`
--

INSERT INTO `joomla_banner_clients` (`id`, `name`, `contact`, `email`, `extrainfo`, `state`, `checked_out`, `checked_out_time`, `metakey`, `own_prefix`, `metakey_prefix`, `purchase_type`, `track_clicks`, `track_impressions`) VALUES
...
--
-- Структура таблицы `joomla_banner_tracks`
--
...
--
-- Структура таблицы `joomla_banners`
--
...
--
-- Дамп данных таблицы `joomla_categories`
--

INSERT INTO `joomla_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`) VALUES
...
--
-- Структура таблицы `joomla_contact_details`
--
...
--
-- Структура таблицы `joomla_content`
--
...
--
-- Дамп данных таблицы `joomla_content`
--

INSERT INTO `joomla_content` (`id`, `asset_id`, `title`, `alias`, `title_alias`, `introtext`, `fulltext`, `state`, `sectionid`, `mask`, `catid`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `images`, `urls`, `attribs`, `version`, `parentid`, `ordering`, `metakey`, `metadesc`, `access`, `hits`, `metadata`, `featured`, `language`, `xreference`) VALUES
...
--
-- Структура таблицы `joomla_content_frontpage`
--
...
--
-- Дамп данных таблицы `joomla_content_frontpage`
--

INSERT INTO `joomla_content_frontpage` (`content_id`, `ordering`) VALUES
(8, 2),
(24, 1),
(35, 4),
(50, 3);
...
--
-- Структура таблицы `joomla_content_rating`
--
...
--
-- Структура таблицы `joomla_core_log_searches`
--
...
--
-- Структура таблицы `joomla_extensions`
--
...
--
-- Дамп данных таблицы `joomla_extensions`
--
...
(801, 'WDB_SilveRado-Compaq', 'template', 'wdb_silverado-compaq', '', 0, 1, 1, 0, '{"legacy":true,"name":"WDB_SilveRado-Compaq","type":"template","creationDate":"December 2010","author":"Efren Pedro Jr","copyright":"WebDesignBuilders","authorEmail":"jadecomputerworks@yahoo.com","authorUrl":"http:\\/\\/webdesignbuilders.net","version":"1.7.0","description":"WDB_Template","group":""}', '{"fontfamily":"ff1","menutype":"mootools","presetstyle":"style1","readmore":"none","bannercolor":"#FFFFFF","bannerfontcolor":"#464646","designby":"design","copy":"December 2010 Silverado Template","googlekey":"","yahookey":"","sponsor":"sponsor-line"}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Структура таблицы `joomla_finder_filters`
--
...
--
-- Структура таблицы `joomla_finder_links`
--
...
--
-- Структура таблицы `joomla_finder_links_terms0`
--
...
--
-- Структура таблицы `joomla_finder_links_terms1`
--
...
--
-- Структура таблицы `joomla_finder_links_terms2`
--
...
--
-- Структура таблицы `joomla_finder_links_terms3`
--
...
--
-- Структура таблицы `joomla_finder_links_terms4`
--
...
--
-- Структура таблицы `joomla_finder_links_terms5`
--
...
--
-- Структура таблицы `joomla_finder_links_terms6`
--
...
--
-- Структура таблицы `joomla_finder_links_terms7`
--
...
--
-- Структура таблицы `joomla_finder_links_terms8`
--
...
--
-- Структура таблицы `joomla_finder_links_terms9`
--
...
--
-- Структура таблицы `joomla_finder_links_termsa`
--
...
--
-- Структура таблицы `joomla_finder_links_termsb`
--
...
--
-- Структура таблицы `joomla_finder_links_termsc`
--
...
--
-- Структура таблицы `joomla_finder_links_termsd`
--
...
--
-- Структура таблицы `joomla_finder_links_termse`
--
...
--
-- Структура таблицы `joomla_finder_links_termsf`
--
...
--
-- Структура таблицы `joomla_finder_taxonomy`
--
...
--
-- Дамп данных таблицы `joomla_finder_taxonomy`
--
...
--
-- Структура таблицы `joomla_finder_taxonomy_map`
--
...
--
-- Структура таблицы `joomla_finder_terms`
--
...
--
-- Структура таблицы `joomla_finder_terms_common`
--
...
--
-- Дамп данных таблицы `joomla_finder_terms_common`
--
...
--
-- Структура таблицы `joomla_finder_tokens`
--
...
--
-- Структура таблицы `joomla_finder_tokens_aggregate`
--
...
--
-- Структура таблицы `joomla_finder_types`
--
...
--
-- Структура таблицы `joomla_languages`
--
...
--
-- Дамп данных таблицы `joomla_languages`
--
...
--
-- Дамп данных таблицы `joomla_menu`
--

INSERT INTO `joomla_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `ordering`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
(1, '', 'Menu_Item_Root', 'root', '', '', '', '', 1, 0, 0, 0, 0, 0, '0000-00-00 00:00:00', 0, 0, '', 0, '', 0, 287, 0, '*', 0),
...
(285, 'aboutjoomla', 'Typography Atomic', 'typography-atomic', '', 'using-joomla/extensions/templates/atomic/typography-atomic', 'index.php?option=com_content&view=article&id=49', 'component', 0, 422, 5, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 3, '{"show_noauth":"","show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","robots":"","rights":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","show_page_heading":0,"page_title":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","secure":0}', 199, 200, 0, '*', 0),
...
(294, 'mainmenu', 'Site Map', 'site-map', '', 'site-map', 'index.php?option=com_content&view=article&id=42', 'component', 0, 1, 1, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_noauth":"","show_title":"","link_titles":"","show_intro":"","show_category":"0","link_category":"","show_parent_category":"0","link_parent_category":"","show_author":"0","link_author":"","show_create_date":"0","show_modify_date":"0","show_publish_date":"0","show_item_navigation":"0","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"0","robots":"","rights":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","show_page_heading":0,"page_title":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","secure":0}', 3, 10, 0, '*', 0),
(296, 'parks', 'Park Links', 'park-links', '', 'park-links', 'index.php?option=com_weblinks&view=category&id=31', 'component', 0, 1, 1, 21, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 114, '{"maxLevel":"-1","show_empty_categories":"","show_description":"1","show_description_image":"1","show_cat_num_articles":"","display_num":"","show_headings":"0","orderby_pri":"","show_pagination":"","show_noauth":"","show_feed_link":"1","feed_summary":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","show_page_heading":0,"page_title":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 253, 254, 0, 'en-GB', 0),
...
(316, 'aboutjoomla', 'Home Page Atomic', 'home-page-atomic', '', 'using-joomla/extensions/templates/atomic/home-page-atomic', 'index.php?option=com_content&view=featured', 'component', 0, 422, 5, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 3, '{"maxLevel":"","show_empty_categories":"","show_description":"","show_description_image":"","show_cat_num_articles":"","num_leading_articles":"1","num_intro_articles":"3","num_columns":"3","num_links":"0","multi_column_order":"1","orderby_pri":"","orderby_sec":"front","order_date":"","show_pagination":"2","show_noauth":"","show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_readmore":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_feed_link":"1","feed_summary":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","show_page_heading":0,"page_title":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 201, 202, 0, '*', 0),
...
(445, 'mainmenu', 'Parks', 'parks', '', 'sample-sites/parks', 'index.php?Itemid=', 'alias', 0, 238, 2, 0, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"aliasoptions":"243","menu-anchor_title":"","menu-anchor_css":"","menu_image":""}', 268, 269, 0, '*', 0),
(446, 'mainmenu', 'Shop', 'shop', '', 'sample-sites/shop', 'index.php?Itemid=', 'alias', 0, 238, 2, 0, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"aliasoptions":"429","menu-anchor_title":"","menu-anchor_css":"","menu_image":""}', 270, 271, 0, '*', 0),
...
(455, 'mainmenu', 'Example Pages', 'example-pages', '', 'example-pages', 'index.php?Itemid=', 'alias', 0, 1, 1, 0, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"aliasoptions":"268","menu-anchor_title":"","menu-anchor_css":"","menu_image":""}', 279, 280, 0, '*', 0),
...
(468, 'mainmenu', 'Контакты', '2012-04-30-04-54-37', '', '2012-04-30-04-54-37', 'index.php?option=com_contact&view=contact&id=8', 'component', 1, 1, 1, 8, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"presentation_style":"","show_contact_category":"","show_contact_list":"","show_name":"","show_position":"","show_email":"","show_street_address":"","show_suburb":"","show_state":"","show_postcode":"","show_country":"","show_telephone":"","show_mobile":"","show_fax":"","show_webpage":"","show_misc":"","show_image":"","allow_vcard":"","show_articles":"","show_links":"","linka_name":"","linkb_name":"","linkc_name":"","linkd_name":"","linke_name":"","show_email_form":"","show_email_copy":"","banned_email":"","banned_subject":"","banned_text":"","validate_session":"","custom_reply":"","redirect":"index.php?option=com_contact&view=contact","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 285, 286, 0, '*', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `joomla_menu_types`
--
...
--
-- Дамп данных таблицы `joomla_menu_types`
--
...
--
-- Структура таблицы `joomla_messages`
--
...
--
-- Структура таблицы `joomla_messages_cfg`
--
...
--
-- Структура таблицы `joomla_modules`
--
...
--
-- Дамп данных таблицы `joomla_modules`
--

INSERT INTO `joomla_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
(16, 'Вход', '', '', 1, 'position-logform', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_login', 1, 1, '{"pretext":"","posttext":"","login":"","logout":"","greeting":"1","name":"0","usesecure":"0","layout":"_:default","moduleclass_sfx":"","cache":"0"}', 0, '*'),
(17, 'Breadcrumbs', '', '', 1, 'position-2', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_breadcrumbs', 1, 1, '{"showHere":"0","showHome":"1","homeText":"\\u0413\\u043b\\u0430\\u0432\\u043d\\u0430\\u044f","showLast":"1","separator":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"itemid"}', 0, '*'),
...
(19, 'Пользователь', '', '', 3, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 2, 1, '{"menutype":"usermenu","startLevel":"1","endLevel":"0","showAllChildren":"0","tag_id":"","class_sfx":"","window_open":"","layout":"_:default","moduleclass_sfx":"_menu","cache":"1","cache_time":"900","cachemode":"itemid"}', 0, '*'),
(20, 'Top', '', '', 1, 'position-1', 42, '2012-04-26 01:26:06', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 1, '{"menutype":"top","startLevel":"1","endLevel":"0","showAllChildren":"0","tag_id":"","class_sfx":"","window_open":"","layout":"","moduleclass_sfx":"","cache":"0"}', 0, '*'),
...
(25, 'Site Map', '', '', 1, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_menu', 1, 0, '{"menutype":"mainmenu","startLevel":"2","endLevel":"3","showAllChildren":"1","tag_id":"","class_sfx":"sitemap","window_open":"","layout":"_:default","moduleclass_sfx":"","cache":"0","cache_time":"900","cachemode":"itemid"}', 0, '*'),
(26, 'Меню', '', '', 5, 'position-menu', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 0, '{"menutype":"mainmenu","startLevel":"1","endLevel":"1","showAllChildren":"0","tag_id":"","class_sfx":"","window_open":"","layout":"_:default","moduleclass_sfx":"_menu","cache":"0","cache_time":"900","cachemode":"itemid"}', 0, '*'),
...
(30, 'Feed Display', '', '', 1, '', 42, '2012-05-01 21:33:57', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_feed', 1, 1, '{"rssurl":"http:\\/\\/community.joomla.org\\/blogs\\/community.feed?type=rss","rssrtl":"0","rsstitle":"1","rssdesc":"1","rssimage":"1","rssitems":"3","rssitemdesc":"1","word_count":"0","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900"}', 0, '*'),
...
(37, 'Syndicate Feeds', '', '', 1, 'syndicateload', 42, '2012-04-25 23:37:35', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_syndicate', 1, 1, '{"text":"Feed Entries","format":"rss","layout":"","moduleclass_sfx":"","cache":"0"}', 0, '*'),
...
(44, 'Login', '', '', 1, '', 42, '2012-04-30 05:29:35', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_login', 1, 1, '{"pretext":"","posttext":"","login":"280","logout":"280","greeting":"1","name":"0","usesecure":"0","layout":"_:default","moduleclass_sfx":"","cache":"0"}', 0, '*'),
(45, 'Menu Example', '', '', 1, '', 42, '2012-05-01 21:34:05', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 1, '{"menutype":"mainmenu","startLevel":"1","endLevel":"0","showAllChildren":"0","tag_id":"","class_sfx":"","window_open":"","layout":"_:default","moduleclass_sfx":"","cache":"0","cache_time":"900","cachemode":"itemid"}', 0, '*'),
...
(52, 'Breadcrumbs', '', '', 1, '', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_breadcrumbs', 1, 1, '{"showHere":"0","showHome":"0","homeText":"\\u0413\\u043b\\u0430\\u0432\\u043d\\u0430\\u044f","showLast":"1","separator":"","layout":"_:default","moduleclass_sfx":"","cache":"0","cache_time":"900","cachemode":"itemid"}', 0, '*'),
...
(61, 'Articles Categories', '', '', 6, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_articles_categories', 1, 1, '{"parent":"29","show_description":"1","show_children":"0","count":"0","maxlevel":"0","layout":"_:default","item_heading":"4","moduleclass_sfx":"","owncache":"1","cache_time":"900"}', 0, '*'),
...
(71, 'Top Menu (Atomic Template)', '', '', 1, 'atomic-topmenu', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_menu', 1, 0, '{"menutype":"aboutjoomla","startLevel":"1","endLevel":"0","showAllChildren":"0","tag_id":"","class_sfx":"","window_open":"","layout":"","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"itemid"}', 0, '*'),
(72, 'Top Quote (Atomic Template)', '', '<hr />\r\n<h2 class="alt">Powerful Content Management and a Simple Extensible Framework.</h2>\r\n<hr />', 1, 'atomic-topquote', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_custom', 1, 0, '{"prepare_content":"1","layout":"","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static"}', 0, '*'),
...
--
-- Структура таблицы `joomla_modules_menu`
--
...
--
-- Дамп данных таблицы `joomla_modules_menu`
--
...
--
-- Структура таблицы `joomla_newsfeeds`
--
...
--
-- Дамп данных таблицы `joomla_newsfeeds`
--

INSERT INTO `joomla_newsfeeds` (`catid`, `id`, `name`, `alias`, `link`, `filename`, `published`, `numarticles`, `cache_time`, `checked_out`, `checked_out_time`, `ordering`, `rtl`, `access`, `language`, `params`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `metakey`, `metadesc`, `metadata`, `xreference`, `publish_up`, `publish_down`) VALUES
...
--
-- Структура таблицы `joomla_overrider`
--
...
--
-- Структура таблицы `joomla_redirect_links`
--
...
--
-- Структура таблицы `joomla_schemas`
--
...
--
-- Дамп данных таблицы `joomla_schemas`
--
...
--
-- Структура таблицы `joomla_session`
--
...
--
-- Дамп данных таблицы `joomla_session`
--

INSERT INTO `joomla_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`, `usertype`) VALUES
('qpqrs5obfiachluecm575ejv42', 0, 1, '1335917939', '__default|a:8:{s:15:"session.counter";i:16;s:19:"session.timer.start";i:1335913667;s:18:"session.timer.last";i:1335917099;s:17:"session.timer.now";i:1335917939;s:22:"session.client.browser";s:74:"Mozilla/5.0 (Windows NT 6.1; WOW64; rv:9.0.1) Gecko/20100101 Firefox/9.0.1";s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":1:{s:5:"users";O:8:"stdClass":1:{s:5:"login";O:8:"stdClass":1:{s:4:"form";O:8:"stdClass":2:{s:6:"return";s:20:"index.php?Itemid=435";s:4:"data";a:4:{s:6:"return";s:20:"index.php?Itemid=435";s:8:"username";s:3:"lol";s:8:"password";s:0:"";s:8:"remember";i:0;}}}}}}s:4:"user";O:5:"JUser":23:{s:9:"\0*\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:8:"usertype";N;s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:0:{}s:5:"guest";i:1;s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:1:{i:0;i:1;}s:14:"\0*\0_authLevels";a:2:{i:0;i:1;i:1;i:1;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"04954dcfb19b7cfa5472a6903aeb7c14";}', 0, '', '');

-- --------------------------------------------------------

--
-- Структура таблицы `joomla_template_styles`
--
...
--
-- Дамп данных таблицы `joomla_template_styles`
--

INSERT INTO `joomla_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
(2, 'bluestork', 1, '1', 'Bluestork - Default', '{"useRoundedCorners":"1","showSiteName":"0"}'),
(3, 'atomic', 0, '0', 'Atomic - Default', '{}'),
(4, 'beez_20', 0, '1', 'Beez2 - Default', '{"wrapperSmall":53,"wrapperLarge":72,"logo":"images\\/joomla_black.gif","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","templatecolor":"nature"}'),
...
(115, 'wdb_silverado-compaq', 0, '0', 'WDB_SilveRado-Compaq - Default', '{"fontfamily":"ff1","menutype":"mootools","presetstyle":"style1","readmore":"none","bannercolor":"#FFFFFF","bannerfontcolor":"#464646","designby":"design","copy":"December 2010 Silverado Template","googlekey":"","yahookey":"","sponsor":"sponsor-line"}');

-- --------------------------------------------------------

--
-- Структура таблицы `joomla_update_categories`
--

CREATE TABLE IF NOT EXISTS `joomla_update_categories` (
...
--
-- Структура таблицы `joomla_update_sites`
--
...
--
-- Дамп данных таблицы `joomla_update_sites`
--

INSERT INTO `joomla_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 0, 1334985259),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 0, 1334985259);

-- --------------------------------------------------------

--
-- Структура таблицы `joomla_update_sites_extensions`
--
...
--
-- Дамп данных таблицы `joomla_update_sites_extensions`
--
...
--
-- Структура таблицы `joomla_updates`
--
...
--
-- Структура таблицы `joomla_user_notes`
--
...
--
-- Структура таблицы `joomla_user_profiles`
--
...
--
-- Структура таблицы `joomla_user_usergroup_map`
--
...
--
-- Дамп данных таблицы `joomla_user_usergroup_map`
--
...
--
-- Структура таблицы `joomla_usergroups`
--
...
--
-- Дамп данных таблицы `joomla_usergroups`
--
...
--
-- Структура таблицы `joomla_users`
--
...
--
-- Дамп данных таблицы `joomla_users`
--

INSERT INTO `joomla_users` (`id`, `name`, `username`, `email`, `password`, `usertype`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`) VALUES
(42, 'Super User', 'admin', 'cahbkooo91@mail.ru', '56494538b04fb04a52dea12634b8a5f0:ClVHFnaU3bCGUWh0Ekef7pIXlEmkcyUz', 'deprecated', 0, 1, '2012-04-21 04:28:12', '2012-05-01 21:21:44', '0', '');

-- --------------------------------------------------------

--
-- Структура таблицы `joomla_viewlevels`
--
...
--
-- Дамп данных таблицы `joomla_viewlevels`
--
...
--
-- Структура таблицы `joomla_weblinks`
--

CREATE TABLE IF NOT EXISTS `joomla_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
...
--
-- Дамп данных таблицы `joomla_weblinks`
--

INSERT INTO `joomla_weblinks` (`id`, `catid`, `sid`, `title`, `alias`, `url`, `description`, `date`, `hits`, `state`, `checked_out`, `checked_out_time`, `ordering`, `archived`, `approved`, `access`, `params`, `language`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `metakey`, `metadesc`, `metadata`, `featured`, `xreference`, `publish_up`, `publish_down`) VALUES
