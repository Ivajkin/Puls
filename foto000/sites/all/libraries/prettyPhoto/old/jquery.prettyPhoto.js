...
(function ($) {
    ...
    $.fn.prettyPhoto = function (pp_settings) {
        ...
        $.prettyPhoto.changePage = function (direction) {
            ...
            if (settings.expand_toggle)
                _expand_img('open_expanded');
        ...
        function _expand_img(e) {
            obj= $('.pp_fade > a');
            if (obj.hasClass('pp_expand')) {
                obj.removeClass('pp_expand').addClass('pp_contract');
                doresize = false;
            } else {
                obj.removeClass('pp_contract').addClass('pp_expand');
                doresize = true;
            }
            ;
            if (e != 'open_expanded')
                settings.expand_toggle= !settings.expand_toggle;
            _hideContent(function () {
                $.prettyPhoto.open();
            });
            return false;
        ...
        function _build_overlay(caller) {
            ...
            $('a.pp_expand').bind('click', function(e){return _expand_img(e);});
